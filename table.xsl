...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="singleCellLenght">
		...
		<xsl:param name="aCellNumber"/>		
			<xsl:choose>
				<xsl:when test="count(tgroup/tbody/row[number($aRowNumber)]/entry[number($aCellNumber)]/child::*) = 2">					
					<xsl:value-of select="string-length(tgroup/tbody/row[$aRowNumber]/entry[$aCellNumber]/child::*[1]/text()) + string-length(tgroup/tbody/row[$aRowNumber]/entry[$aCellNumber]/child::*[2]/text())"/>
				</xsl:when>
				<xsl:when test="count(tgroup/tbody/row[number($aRowNumber)]/entry[number($aCellNumber)]/child::*) = 3">					
					<xsl:value-of select="string-length(tgroup/tbody/row[$aRowNumber]/entry[$aCellNumber]/child::*[1]/text()) + string-length(tgroup/tbody/row[$aRowNumber]/entry[$aCellNumber]/child::*[2]/text()) +  string-length(tgroup/tbody/row[$aRowNumber]/entry[$aCellNumber]/child::*[3]/text())"/>
				</xsl:when>
				<xsl:when test="count(tgroup/tbody/row[number($aRowNumber)]/entry[number($aCellNumber)]/child::*)&gt;= 4">					
					<xsl:value-of select="string-length(tgroup/tbody/row[$aRowNumber]/entry[$aCellNumber]/child::*[1]/text()) + string-length(tgroup/tbody/row[$aRowNumber]/entry[$aCellNumber]/child::*[2]/text()) +  string-length(tgroup/tbody/row[$aRowNumber]/entry[$aCellNumber]/child::*[3]/text()) +  string-length(tgroup/tbody/row[$aRowNumber]/entry[$aCellNumber]/child::*[4]/text())"/>
				</xsl:when>
				<xsl:otherwise>
