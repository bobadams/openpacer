...
P.breakhere {page-break-before: always}
		...
		<xsl:choose>
			...
			<xsl:when test="ancestor::committee-report-form">
				<center>
					...
					<xsl:if test="(@display-inline='yes-display-inline'  or not(@display-inline) )and preceding-sibling::action-date[@display='yes']">
						<xsl:choose>
			...
			<xsl:when test="$isReport='yes'  or contains(translate($documentStage,$upper,$lower), 'engrossed')">
	...
	<xsl:template match="section">
		<xsl:choose>
			...
			<xsl:when test="@reported-display-style='boldface-italic' or   ancestor::*[@reported-display-style='boldface-italic']">
				<i>
					<span class="sectionlevelOLCBold">
						<xsl:call-template name="displaySection"/>
					</span>
	...
	<xsl:template name="displayEnumRules">
		...
		<xsl:if test="ancestor::quoted-block and not(parent::*/@display-inline='yes-display-inline')">
	...
	<xsl:template name="displayEnumSection">
		<xsl:param name="aCurrElementStyle"/>		
		<xsl:choose>
			<xsl:when test="parent::section/parent::constitution-article/parent::quoted-block/@style='traditional' or parent::section/parent::constitution-article/parent::quoted-block/@style='traditional' or parent::section/parent::constitution-article/parent::quoted-block/@style='appropriations'">
				<!--xsl:text>“</xsl:text-->
			...
			<xsl:when test="parent::section[@section-type='section-one']/parent::legis-body[@added-display-style='boldface-roman'] or   parent::section[@section-type='section-one']/parent::legis-body[@reported-display-style='boldface-roman'] ">
				<span class="sectionlevelOLCBold">
					<xsl:call-template name="createAnchorParent"/>
					<xsl:text>SECTION </xsl:text>					
					<!-- TB 19May2008 -->
			...
			<xsl:when test="(string(parent::section/@section-type)='section-one')">
				<xsl:choose>
					<xsl:when test="ancestor::*[@reported-display-style='boldface-roman']     or ancestor::*[@reported-display-style='boldface-italic']">
						<span class="sectionlevelOLCBold">
							<xsl:call-template name="createAnchorParent"/>
							<xsl:text>SECTION </xsl:text>
							<!-- TB 19May2008 -->
					...
					<xsl:when test="not(ancestor::quoted-block)  and (contains($aCurrElementStyle,'traditional') or $aCurrElementStyle='appropriations')">
						<span class="initialcapTrad">
							<xsl:call-template name="createAnchorParent"/>
							<xsl:text>section </xsl:text>
							<!-- TB 19May2008 -->
					...
					<xsl:when test="($billStage='Introduced-in-House' or $billStage='Engrossed-in-House' or     $billStage='Received-in-Senate' or $billStage='Received-in-House' or     $billStage='Referred-in-Senate' or $billStage='Referred-in-House' or     $billStage='Engrossed-in-Senate'or $billStage='Reported-in-House' or $billStage='Pre-Introduction'     or $resolutionStage='Introduced-in-House' or $resolutionStage='Introduced-in-Senate'       or $billStage='Reported-in-Senate' or $billStage='Enrolled-Bill' or $billStage='Introduced-in-Senate' or         $resolutionStage='Received-in-Senate' or  $resolutionStage='Reported-in-House'       or $resolutionStage='Enrolled-Bill'  or $resolutionStage='Engrossed-in-House'  ) and       not(parent::*[@reported-display-style='boldface-italic']  )">
			...
			<xsl:when test="string(parent::section/@section-type) ='subsequent-section' ">
				<xsl:choose>
					...
					<xsl:when test="     ancestor::*[@reported-display-style='boldface-roman'] or     ancestor::*[@reported-display-style='boldface-italic'] or     not(ancestor::quoted-block) and not($billType='traditional') and     (parent::section[@section-type='subsequent-section']/parent::legis-body[@added-display-style='boldface-roman'] or     parent::section[@section-type='subsequent-section']/parent::legis-body[@reported-display-style='boldface-roman'] or     parent::*[@reported-display-style='boldface-roman'] or     parent::*[@added-display-style='boldface-roman']        )     ">
						<span class="sectionlevelOLCBold">
							<xsl:call-template name="createAnchorParent"/>
							<xsl:if test="ancestor::quoted-block">
								<xsl:call-template name="openQuotes"/>
					...
					<xsl:when test="$aCurrElementStyle ='nuclear'  or $aCurrElementStyle='traditional-inline'">
						<span class="sectionlevelOLCnuclear">
							<xsl:call-template name="createAnchorParent"/>
					...
					<xsl:when test="(not(ancestor::quoted-block) and not($billType='traditional') and not($billType='appropriations') and not ($aCurrElementStyle='traditional')) or (ancestor::quoted-block and $aCurrElementStyle='defense')">
						<span class="sectionlevelOLC">
							<xsl:call-template name="createAnchorParent"/>
							<xsl:if test="ancestor::quoted-block">
								<xsl:call-template name="openQuotes"/>
					...
					<xsl:when test="ancestor::legis-body/@added-display-style='boldface-roman' and     (ancestor::quoted-block/@style='OLC' or ancestor::quoted-block/@style='tax')">
	...
	<xsl:template name="displayEnumTitle">
		...
		<xsl:choose>
			...
			<!--xsl:when
				...
				"-->
			<xsl:when test="contains($aCurrElementStyle,'traditional') or contains($aCurrElementStyle,'archaic') or $aCurrElementStyle='appropriations'">
			...
			<xsl:when test="ancestor::legis-body/@style='USC' or     ancestor::quoted-block[@style='quoted-block']">
	...
	<xsl:template name="displayEnumSubtitle">
		...
		<xsl:choose>
			...
			<xsl:when test="(parent::subtitle[@reported-display-style='boldface-italic']/ancestor::quoted-block[@style='tax'])or      ancestor::*[@reported-display-style='boldface-italic'] and ancestor::quoted-block[@style='tax']">
	...
	<xsl:template name="displayEnumPart">
		...
		<xsl:choose>
			...
			<xsl:when test="(parent::part[@reported-display-style='boldface-roman'] and ancestor::quoted-block[@style='tax']) or     parent::part/parent::quoted-block[@style='tax']/ancestor::*[@reported-display-style='boldface-roman']">
			...
			<xsl:when test="(parent::part[@reported-display-style='boldface-italic']/ancestor::quoted-block[@style='tax'])or     (parent::part and ancestor::*[@reported-display-style='boldface-italic'] and ancestor::quoted-block[@style='tax'])">
				<span class="partlevelIRCBold">
					<xsl:call-template name="ActualPrintHeadingOf">
						<xsl:with-param name="aTextToAdd">
							<xsl:text>PART </xsl:text>
	...
	<xsl:template name="displayEnumSubpart">
		...
		<xsl:choose>
			...
			<xsl:when test="ancestor::quoted-block[@style='tax']/ancestor::*[@reported-display-style='boldface-roman']     or ancestor::*[@reported-display-style='boldface-italic'] and ancestor::quoted-block[@style='tax']">
	...
	<xsl:template name="displayEnumChapter">
		...
		<xsl:choose>
			...
			<xsl:when test="$aCurrElementStyle='traditional-inline' or $aCurrElementStyle='appropriations'">
	...
	<xsl:template name="displayEnumSubchapter">
		...
		<xsl:choose>
			...
			<xsl:when test="ancestor::quoted-block/@style='traditional' or     $documentType ='traditional' or     (ancestor::quoted-block/@other-style='archaic') ">
			...
			<xsl:when test="(parent::subchapter[@reported-display-style='boldface-roman'] and ancestor::quoted-block[@style='tax']) or     parent::subchapter/parent::quoted-block[@style='tax']/ancestor::*[@reported-display-style='boldface-roman']     or (parent::subchapter and ancestor::*[@reported-display-style='boldface-italic'])">
	...
	<xsl:template match="header">
		...
		<xsl:choose>
			<xsl:when test="parent::toc and not (//committee-report)  and following-sibling::multi-column-toc-entry">
				<!-- nothing -->
			</xsl:when>
			<xsl:when test="parent::appropriations-major or parent::appropriations-intermediate or parent::appropriations-small">
	...
	<xsl:template name="displayCommitteeReportHeader">
		...
		<xsl:choose>
			...
			<xsl:when test="$isDisplayInline='yes-display-inline' and $isMarginIndent = 'yes' and $isFollowingDisplayinline='no-display-inline'">
				<p class="indent" align="justify">
					<xsl:call-template name="actualPrintCommitteeReportHeader"/>
				</p>									
			</xsl:when>
			<xsl:when test="$isDisplayInline='yes-display-inline' and $isMarginIndent = 'yes' and $isFollowingDisplayinline='yes-display-inline'">					
	...
	<xsl:template name="displayHeader">
		...
		<xsl:choose>
			...
			<xsl:when test="$billType='olc' and ((parent::section and ancestor::legis-body/@added-display-style='boldface-roman') or     parent::*[@reported-display-style='boldface-roman'] or     parent::*[@added-display-style='boldface-roman'])">
				<span class="sectionlevelOLCBold">
					<xsl:text> </xsl:text>
					<xsl:value-of select="translate(.,$lower,$upper)"/>
					<xsl:text>.</xsl:text>
			...
			<xsl:when test="parent::subsection and ($currElementStyle='archaic'  or $currElementStyle='archaic-paragraph')">
			...
			<xsl:when test="parent::subsection or parent::paragraph or parent::subparagraph or parent::clause or parent::subclause or parent::item or parent::subitem">
				<xsl:call-template name="displayTitleByStyle">
					<xsl:with-param name="currElementStyle" select="$currElementStyle"/>
				</xsl:call-template>
				<xsl:text>.—</xsl:text>
				<xsl:choose>
					<xsl:when test="not(following-sibling::*) and name(ancestor::quoted-block/child::*[2])='after-quoted-block'">
						<xsl:text>”</xsl:text>
						<!--xsl:value-of
			...
			<xsl:otherwise>
				...
				<xsl:if test="not(following-sibling::*) and name(parent::quoted-block/child::*[2])='after-quoted-block'">
					<xsl:text>”</xsl:text>
					<xsl:value-of select="ancestor::quoted-block/child::after-quoted-block"/>
				</xsl:if>
			</xsl:otherwise>
	...
	<xsl:template name="displayHeaderSection">
		...
		<xsl:choose>
			...
			<xsl:when test="($billType='traditional' and ancestor::*[@reported-display-style='boldface-roman'])">
				<span class="sectionlevelTradBold">
					<xsl:text> </xsl:text>					
					<xsl:apply-templates/>
				</span>
			...
			<xsl:when test="$billType='olc' and (parent::section/parent::legis-body[@added-display-style='boldface-roman'] or     parent::section/parent::legis-body[@reported-display-style='boldface-roman'] or     (parent::section and ancestor::*[@reported-display-style='boldface-roman']) or     (parent::section and ancestor::*[@reported-display-style='boldface-italic']))             ">
				<span class="sectionlevelOLCBold">
					<xsl:text> </xsl:text>
					<xsl:value-of select="translate(.,$lower,$upper)"/>
					<xsl:text>.</xsl:text>
			...
			<xsl:when test="$aCurrElementStyle = 'nuclear' or  $aCurrElementStyle='traditional-inline'">
				<span class="sectionlevelOLCnuclear">
					...
					<xsl:text>.</xsl:text>
					<!--TB 28Dec2007 Bug #767 -->
					<xsl:if test="$aCurrElementStyle='traditional-inline' and following-sibling::*/@display-inline='yes-display-inline'">
						<span class="sectionlevelOLCnuclear">
							<xsl:text>—</xsl:text>
			...
			<xsl:when test="contains($aCurrElementStyle, 'archaic')">
				<span class="sectionTitleTrad">
					...
					<xsl:if test="(ancestor::quoted-block and $toCloseQuotes='false' ) or following-sibling::* or not (ancestor::quoted-block)">
						<xsl:text>.</xsl:text>
					</xsl:if>
					<!-- if there is only an enum and a header within a quoted block display a ".	-->
					<xsl:if test="(not(following-sibling::*) and name(ancestor::quoted-block/child::*[2])='after-quoted-block') and not ($aCurrElementStyle='OLC')">
						<!--xsl:text>”.</xsl:text-->
						<xsl:call-template name="closeQuotesByCondition"/>
					</xsl:if>
				</span>
	...
	<xsl:template name="displayHeaderPart">
		...
		<xsl:choose>
			...
			<xsl:when test="(parent::part[@reported-display-style='boldface-italic']/ancestor::quoted-block[@style='tax']) or     (ancestor::*[@reported-display-style='boldface-italic'] and ancestor::quoted-block[@style='tax'])">
				<span class="partlevelIRCBold">
					<span align="center"><xsl:text>—</xsl:text></span>
					<!--xsl:value-of select="translate(.,$lower,$upper)"/-->
					<xsl:call-template name="printCompHeader"/>
	...
	<xsl:template name="displayHeaderSubpart">
		...
		<xsl:choose>
			...
			<xsl:when test="ancestor::quoted-block[@style='tax']/ancestor::*[@reported-display-style='boldface-roman']">
				<span class="subpartlevelIRCBold">
					<span align="center"><xsl:text>—</xsl:text></span>
					<xsl:value-of select="."/>
					<xsl:if test="not(following-sibling::*) and name(ancestor::quoted-block/child::*[2])='after-quoted-block'">
			...
			<xsl:when test="(ancestor::*[@reported-display-style='boldface-italic'] and ancestor::quoted-block[@style='tax'])">
				<span class="subpartlevelIRCBold">
					<span align="center"><xsl:text>—</xsl:text></span>
					<xsl:value-of select="."/>
					<xsl:if test="not(following-sibling::*) and name(ancestor::quoted-block/child::*[2])='after-quoted-block'">
	...
	<xsl:template name="displayHeaderSubchapter">
		...
		<xsl:choose>
			...
			<xsl:when test="$aCurrElementStyle='traditional'  or contains($aCurrElementStyle, 'archaic')">
				<span class="chapterlevelOLCnuclear">
					<span align="center"><xsl:text>—</xsl:text></span>
					<!--xsl:value-of select="translate(.,$lower,$upper)"/-->
					<!--xsl:apply-templates/-->
	...
	<xsl:template name="iAmALastSibling">
		...
		<xsl:choose>
			...
			<xsl:when test="local-name() = 'section'  and $ReportingDisplayStyle='bold-brackets'">
				<xsl:text>true</xsl:text>
			</xsl:when>			
			<xsl:when test="local-name() = 'text' and local-name(ancestor::*[1]) = 'section'  and $ReportingDisplayStyle='bold-brackets'">
				<xsl:text>true</xsl:text>
			</xsl:when>			
			...
			<xsl:when test="contains(local-name(ancestor::*[1]),'appropriations' ) and $source != 'toc'">
				<xsl:text>true</xsl:text>
			</xsl:when>			
			...
			<xsl:when test="(ancestor::*[2]/ following-sibling::* and not(local-name(ancestor::*[2]/following-sibling::*[1]) ='after-quoted-block') and not(local-name(ancestor::*[2]/following-sibling::*[1]) ='endorsement') or (ancestor::*[2]/following-sibling::*[2]))">
				<xsl:text>false</xsl:text>
			</xsl:when>	
			<xsl:when test="local-name(ancestor::*[3])='quoted-block'  and $source != 'toc'">
				<xsl:text>true</xsl:text>
			</xsl:when>
			<xsl:when test="(ancestor::*[3]/ following-sibling::* and not(local-name(ancestor::*[3]/following-sibling::*[1]) ='after-quoted-block') and not(local-name(ancestor::*[3]/following-sibling::*[1]) ='endorsement') or (ancestor::*[3]/following-sibling::*[2]))">
				<xsl:text>false</xsl:text>
			</xsl:when>	
			<xsl:when test="local-name(ancestor::*[4])='quoted-block'  and $source != 'toc'">
				<xsl:text>true</xsl:text>
			</xsl:when>
			<xsl:when test="(ancestor::*[4]/ following-sibling::* and not(local-name(ancestor::*[4]/following-sibling::*[1]) ='after-quoted-block') and not(local-name(ancestor::*[4]/following-sibling::*[1]) ='endorsement') or (ancestor::*[4]/following-sibling::*[2]))">
				<xsl:text>false</xsl:text>
			</xsl:when>		
	...
	<xsl:template name="CloseSiblingSectionLevel">
		<xsl:variable name="selfOrParentDeleted">
			<xsl:choose>
				<xsl:when test="self::section/@changed='deleted' or ancestor::section[1]/@changed='deleted' or (ancestor::title/@changed='deleted' and not(ancestor::section[1]/@changed))">
					<xsl:text>true</xsl:text>
				</xsl:when>
				<xsl:otherwise>
					<xsl:text>false</xsl:text>
		...
		<xsl:variable name="followingOrParentDeleted">
			<xsl:choose>
				<xsl:when test="self::section/following-sibling::section[1]/@changed='deleted' or ancestor::section[1]/following-sibling::section[1]/@changed='deleted' or (ancestor::title/@changed='deleted' and not(ancestor::sectioon[1]/following-sibling::section/@changed))">
					<xsl:text>true</xsl:text>
				</xsl:when>
				<xsl:otherwise>
					<xsl:text>false</xsl:text>
		...
		<xsl:choose>
			...
			<xsl:when test="$selfOrParentDeleted='true' and $ReportedDisplayStyle='bold-brackets' and $followingOrParentDeleted='true' and $ReportedDisplayStyleFollowingSibling='bold-brackets' and (not (following-sibling::*) or local-name() = 'section') and ( $lastInSection='true')">
				<xsl:text>yes</xsl:text>
			</xsl:when>		
			<xsl:when test="$selfOrParentDeleted='true' and $ReportedDisplayStyle='bold-brackets'  and local-name() = 'section' and $lastInSection='true'">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<xsl:when test="$selfOrParentDeleted='true' and $ReportedDisplayStyle='bold-brackets'  and $lastInSection='true'">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<xsl:otherwise>
				<xsl:text>no</xsl:text>
	...
	<xsl:template name="checkSiblingsRule">
		...
		<xsl:choose>
			...
			<xsl:when test="ancestor::appropriations-major[1][@changed='deleted' and @reported-display-style='bold-brackets' ]      and (ancestor::appropriations-major[1]/following-sibling::appropriations-major[1][@changed='deleted' and @reported-display-style='bold-brackets']     or ancestor::appropriations-major[1]/following-sibling::appropriations-intermediate[1][@changed='deleted' and @reported-display-style='bold-brackets']     or ancestor::appropriations-major[1]/following-sibling::appropriations-small[1][@changed='deleted' and @reported-display-style='bold-brackets'])     and not (following-sibling::*) and ( (local-name(parent::*/following-sibling::*) = 'appropriations-major'  or  local-name(parent::*/following-sibling::*) = 'appropriations-intermediate'  or local-name(parent::*/following-sibling::*) = 'appropriations-small' ) or not (parent::*/following-sibling::*))">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<!-- Appropriations intermediate following by appropriations any type -->
			<xsl:when test="ancestor::appropriations-intermediate[1][@changed='deleted' and @reported-display-style='bold-brackets' ]      and (ancestor::appropriations-intermediate[1]/following-sibling::appropriations-major[1][@changed='deleted' and @reported-display-style='bold-brackets']     or ancestor::appropriations-intermediate[1]/following-sibling::appropriations-intermediate[1][@changed='deleted' and @reported-display-style='bold-brackets']     or ancestor::appropriations-intermediate[1]/following-sibling::appropriations-small[1][@changed='deleted' and @reported-display-style='bold-brackets'])     and not (following-sibling::*) and ( (local-name(parent::*/following-sibling::*) = 'appropriations-major'  or  local-name(parent::*/following-sibling::*) = 'appropriations-intermediate'  or local-name(parent::*/following-sibling::*) = 'appropriations-small' ) or not (parent::*/following-sibling::*))">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<!-- Appropriations small following by appropriations any type -->
			<xsl:when test="ancestor::appropriations-small[1][@changed='deleted' and @reported-display-style='bold-brackets' ]      and (ancestor::appropriations-small[1]/following-sibling::appropriations-major[1][@changed='deleted' and @reported-display-style='bold-brackets']     or ancestor::appropriations-small[1]/following-sibling::appropriations-intermediate[1][@changed='deleted' and @reported-display-style='bold-brackets']     or ancestor::appropriations-small[1]/following-sibling::appropriations-small[1][@changed='deleted' and @reported-display-style='bold-brackets'])     and not (following-sibling::*) and ( (local-name(parent::*/following-sibling::*) = 'appropriations-major'  or  local-name(parent::*/following-sibling::*) = 'appropriations-intermediate'  or local-name(parent::*/following-sibling::*) = 'appropriations-small' ) or not (parent::*/following-sibling::*))">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<!-- appropriation small last in title -->
			<xsl:when test="ancestor::appropriations-small[1][@changed='deleted' and @reported-display-style='bold-brackets' ]      and  ancestor::appropriations-small[1]/parent::title and not (ancestor::appropriations-small[1]/following-sibling::*)  and not (following-sibling::*)">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<!-- appropriation intermediate last in title -->
			<xsl:when test="ancestor::appropriations-intermediate[1][@changed='deleted' and @reported-display-style='bold-brackets' ]      and  ancestor::appropriations-intermediate[1]/parent::title and not (ancestor::appropriations-intermediate[1]/following-sibling::*) and not (following-sibling::*)">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<!-- appropriation major last in title -->
			<xsl:when test="ancestor::appropriations-major[1][@changed='deleted' and @reported-display-style='bold-brackets' ]      and  ancestor::appropriations-major[1]/parent::title and not (ancestor::appropriations-major[1]/following-sibling::*)  and not (following-sibling::*)">
				<xsl:text>yes</xsl:text>
			</xsl:when>
	...
	<xsl:template name="toCloseTheBrakets">
		...
		<xsl:variable name="isAncestorDeleted">
			<xsl:choose>
				<xsl:when test="contains(ancestor-or-self::*/@reported-display-style, 'brackets')">
					<xsl:text>true</xsl:text>
				</xsl:when>
				<xsl:otherwise>
					<xsl:text>false</xsl:text>
		...
		<xsl:variable name="isAncestorDeleted1">
			<xsl:choose>
				...
				<xsl:when test="contains(ancestor::*[1]/ancestor::*/@reported-display-style, 'brackets')">
					<xsl:text>true</xsl:text>
				</xsl:when>
				<xsl:otherwise>
					<xsl:text>false</xsl:text>
		...
		<xsl:variable name="isAncestorDeleted2">
			<xsl:choose>
				<xsl:when test="contains(ancestor::*[2]/ancestor::*/@reported-display-style, 'brackets')">
					<xsl:text>true</xsl:text>
				</xsl:when>
				<xsl:otherwise>
					<xsl:text>false</xsl:text>
		...
		<xsl:variable name="isAncestorDeleted3">
			<xsl:choose>
				<xsl:when test="contains(ancestor::*[3]/ancestor::*/@reported-display-style, 'brackets')">
					<xsl:text>true</xsl:text>
				</xsl:when>
				<xsl:otherwise>
					<xsl:text>false</xsl:text>
		...
		<xsl:variable name="isAncestorDeleted4">
			<xsl:choose>
				<xsl:when test="contains(ancestor::*[4]/ancestor::*/@reported-display-style, 'brackets')">
					<xsl:text>true</xsl:text>
				</xsl:when>
				<xsl:otherwise>
					<xsl:text>false</xsl:text>
		...
		<xsl:variable name="isAncestorDeleted5">
			<xsl:choose>
				<xsl:when test="contains(ancestor::*[5]/ancestor::*/@reported-display-style, 'brackets')">
					<xsl:text>true</xsl:text>
				</xsl:when>
				<xsl:otherwise>
					<xsl:text>false</xsl:text>
		...
		<xsl:variable name="isAncestorDeleted6">
			<xsl:choose>
				<xsl:when test="contains(ancestor::*[6]/ancestor::*/@reported-display-style, 'brackets')">
					<xsl:text>true</xsl:text>
				</xsl:when>
				<xsl:otherwise>
					<xsl:text>false</xsl:text>
		...
		<xsl:choose>			
			...
			<xsl:when test="(local-name() = 'added-phrase' or local-name()='deleted-phrase')  and contains(@reported-display-style,'brackets')">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			...
			<xsl:when test="(following-sibling::*[1]/text() or  following-sibling::*[1]/text or following-sibling::*[1]/child::*/text()) and not(following-sibling::*[1][(@changed='deleted' or (not(@changed) and $isAncestorDeleted='true')) and (contains($ReportedDisplayStyle, 'brackets' ))])  and $isChildLast='true'">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<xsl:when test="not(following-sibling::*) and (ancestor::*[1]/following-sibling::*[1]/text != '' or ancestor::*[1]/following-sibling::*[1]/text() or ancestor::*[1]/following-sibling::*[1]/child::*/text() ) and not(ancestor::*[1]/following-sibling::*[1][(@changed='deleted' or (not(@changed) and $isAncestorDeleted1='true')) and (contains($ReportedDisplayStyle,'brackets' ))] ) and $isChildLast='true'">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<xsl:when test="not (ancestor::*[1]/following-sibling::*) and ancestor::*[2]/following-sibling::*[1]/text != ''  and not(ancestor::*[2]/following-sibling::*[1][(@changed='deleted' or (not(@changed) and $isAncestorDeleted2='true')) and (contains($ReportedDisplayStyle, 'brackets' ))] ) and $isChildLast='true'">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<xsl:when test="(not (ancestor::*[2]/following-sibling::*) and not (local-name(ancestor::*[2])='quoted-block'))and ancestor::*[3]/following-sibling::*[1]/text != ''  and (ancestor::*[3]/following-sibling::*[1][(@changed='deleted' or (not(@changed) and $isAncestorDeleted3='true')) and (contains($ReportedDisplayStyle, 'brackets' ))]) and $isChildLast='true'  and $isSiblingsRuleTrue='no'">
				<xsl:text>no</xsl:text>
			</xsl:when>
			<xsl:when test="(not (ancestor::*[2]/following-sibling::*) and not (local-name(ancestor::*[2])='quoted-block'))and ancestor::*[3]/following-sibling::*[1]/text != ''  and (ancestor::*[3]/following-sibling::*[1][(@changed='deleted' or (not(@changed) and $isAncestorDeleted3='true')) and (contains($ReportedDisplayStyle, 'brackets' ))]) and $isChildLast='true'  ">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<xsl:when test="not (ancestor::*[3]/following-sibling::*) and ancestor::*[4]/following-sibling::*[1]/text != '' and ancestor::*[4]/following-sibling::*[1][(@changed='deleted' or (not(@changed) and $isAncestorDeleted4='true')) and (contains($ReportedDisplayStyle, 'brackets' ) or (not (@reported-display-style) and $isAncestorDeleted4='true'))]  and $isChildLast='true' and $isSiblingsRuleTrue='no'">
				<xsl:text>no</xsl:text>
			</xsl:when>
			<xsl:when test="not (ancestor::*[3]/following-sibling::*) and ancestor::*[4]/following-sibling::*[1]/text != '' and ancestor::*[4]/following-sibling::*[1][(@changed='deleted' or (not(@changed) and $isAncestorDeleted4='true')) and (contains($ReportedDisplayStyle, 'brackets' ) or (not (@reported-display-style) and $isAncestorDeleted4='true'))]  and $isChildLast='true'">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<xsl:when test="not (ancestor::*[4]/following-sibling::*) and ancestor::*[5]/following-sibling::*[1]/text != '' and ancestor::*[5]/following-sibling::*[1][(@changed='deleted' or (not(@changed) and $isAncestorDeleted5='true')) and (contains($ReportedDisplayStyle, 'brackets' ))] and $isChildLast='true' ">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<xsl:when test="not (ancestor::*[5]/following-sibling::*) and ancestor::*[6]/following-sibling::*[1]/text != '' and ancestor::*[6]/following-sibling::*[1][(@changed='deleted' or (not(@changed) and $isAncestorDeleted6='true')) and (contains($ReportedDisplayStyle, 'brackets' ) )]  and $isChildLast='true' ">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<xsl:when test="(not (following::*) or local-name (following::*[1]) = 'endorsement') and $isChildLast='true' and not (local-name(child::*[position()=last()]) = 'subsection') ">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<xsl:when test="local-name(following-sibling::*[1])='after-quoted-block' and not (following-sibling::*[1]/following::*) and $isChildLast='true' ">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<!--xsl:when
			...
			<xsl:when test="not (following-sibling::*)      and local-name(parent::*/following-sibling::*[1])='after-quoted-block'       and  (not (parent::*/following-sibling::*[2][@changed='deleted'  or not(@changed) and (contains($ReportedDisplayStyle, 'brackets' ) )])     and (not (parent::*/following-sibling::*[2]) and not (ancestor::*[2]/following-sibling::*[2][@changed='deleted'  or not(@changed) and (contains($ReportedDisplayStyle, 'brackets' ) )])))">
			...
			<xsl:when test="$billType='appropriations' and local-name()='list-item' and (parent::list[@changed='deleted'] and contains($ReportedDisplayStyle,'brackets'))  and not  (following-sibling::*) and not (parent::list/following-sibling::*[1][@changed = 'deleted'] and contains($ReportedDisplayStyle,'brackets'))">
				<xsl:text>yes</xsl:text>
			</xsl:when>				
			<xsl:when test="$lastInSection = 'true' and  contains($ReportedDisplayStyle, 'brackets' )">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<xsl:when test="(following-sibling::*[1]/@changed and  not(following-sibling::*[1]/@changed = 'deleted')     and following-sibling::*[1]/@reported-display-style != 'bold-brackets') and (contains($ReportedDisplayStyle,'brackets' ) )">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<xsl:when test="not(following-sibling::*) and  contains(parent::*/@reported-display-style, 'brackets') and not (contains(parent::*/following-sibling::*[1]/@reported-display-style, 'brackets'))">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			...
			<!--xsl:when test="contains(@reported-display-style,'brackets') and (following-sibling::*[1] and not (contains(following-sibling::*[1]/@reported-display-style, 'brackets' )) and not (contains(parent::*/@reported-display-style, 'brackets')) and not (following-sibling::*[1]/@changed='not-changed')
				or (not (following-sibling::*) and ancestor::*[1]/following-sibling::*[1]  and not(contains(ancestor::*[1]/following-sibling::*[1]/@reported-display-style, 'brackets')) ))"-->
			<xsl:when test="contains(@reported-display-style,'brackets') and (following-sibling::*[1] and not (contains(following-sibling::*[1]/@reported-display-style, 'brackets' ))      and not (contains(parent::*/@reported-display-style, 'brackets')) and not (following-sibling::*[1]/@changed='not-changed') and      not(contains(ancestor::*[2]/@reported-display-style, 'brackets')) and not(contains(ancestor::*[3]/@reported-display-style, 'brackets')) and      not(contains(ancestor::*[4]/@reported-display-style, 'brackets'))     or (not (following-sibling::*) and ancestor::*[1]/following-sibling::*[1]  and      not(contains(ancestor::*[1]/following-sibling::*[1]/@reported-display-style, 'brackets')) ))">
	...
	<xsl:template match="part|subpart|division|subdivision">
		<xsl:choose>
			...
			<xsl:when test="@added-display-style='italic' or @reported-display-style='italic' or (ancestor-or-self::*/@added-display-style='italic' or ancestor-or-self::*/@reported-display-style='italic' )">
				<i>
					<xsl:call-template name="displaySub"/>
				</i>
			</xsl:when>
	...
	<xsl:template match="toc/child::*//text()">
		...
		<xsl:choose>
			<xsl:when test="($parentOrLevel='part' or $parentOrLevel='subpart' ) and $currElementStyle='tax'">
				<span style="text-transform:capitalize">
					<xsl:value-of select="."/>
				</span>
			</xsl:when>
			<xsl:when test="$parentOrLevel='division' or $parentOrLevel='title' or $parentOrLevel='part' or $parentOrLevel='subpart' or $parentOrLevel='chapter' or $parentOrLevel='subchapter'">
				<xsl:value-of select="translate(.,$lower,$upper)"/>
			</xsl:when>
			...
			<xsl:when test="$parentOrLevel='subtitle' or $parentOrLevel='subchapter'     or $parentOrLevel='part' or $parentOrLevel='subpart'">
				<xsl:value-of select="."/>
			</xsl:when>			
			<xsl:otherwise>
				<xsl:value-of select="."/>
	...
	<xsl:template match="text()">
		...
		<xsl:choose>
			...
			<xsl:when test="following::text()[1]=ancestor::quoted-block/after-quoted-block">
				<xsl:choose>
					<xsl:when test="../parent::section and parent::header and $currentElementStyle='traditional' ">
						<span class="simplecap" style="text-transform: uppercase;font-weight: normal;">
							<xsl:value-of select="."/>
					...
					<xsl:otherwise>
						...
						<!--xsl:value-of select="."/-->
						<xsl:choose>
							<xsl:when test="name(..)!='added-phrase' and name(..)!='entry' and name(..)!='act-name' and         following::*[1]=ancestor::quoted-block/after-quoted-block and not(parent::quote)">
			...
			<xsl:when test="../parent::subchapter and parent::header  and ($currentElementStyle='archaic-paragraph')">
				<xsl:value-of select="translate(., $lower, $upper)"/>
			</xsl:when>
	...
	<xsl:template name="ActualPrintIChangedTextWithParam">
		...
		<xsl:choose>
			...
			<xsl:when test="ancestor::amendment-block[@changed='added' and @reported-display-style='italic'] ">
				<i>
					<xsl:value-of select="$aTheTextToPrint"/>
				</i>
			</xsl:when>
			<xsl:when test="ancestor::amendment-block[@changed='added' and @reported-display-style='boldface-italic']">
				<span style="font-weight: bold; font: italic;">
					<xsl:value-of select="$aTheTextToPrint"/>
				</span>
			</xsl:when>
			<xsl:when test="ancestor::whereas[@changed='deleted' and @reported-display-style='strikethrough']">
				<strike>
					<xsl:value-of select="$aTheTextToPrint"/>
				</strike>
			</xsl:when>
			<xsl:when test="ancestor::amendment-block[@changed='deleted' and @reported-display-style='strikethrough']">
				<strike>
					<xsl:value-of select="$aTheTextToPrint"/>
				</strike>
			</xsl:when>
			<xsl:when test="ancestor::*[@changed='deleted' and @reported-display-style='strikethrough'] and ancestor::table">
				<strike>
					<xsl:value-of select="$aTheTextToPrint"/>
				</strike>
			</xsl:when>
			<xsl:when test="ancestor::*[@changed='added' and @reported-display-style='italic'] and ancestor::table">
				<i>
					<xsl:value-of select="$aTheTextToPrint"/>
				</i>
			</xsl:when>
			<xsl:when test="ancestor::*[@changed='added' and @reported-display-style='boldface-italic']">
				<span style="font-weight:bold;font: italic;">
					<xsl:value-of select="$aTheTextToPrint"/>
				</span>
			</xsl:when>
	...
	<xsl:template match="text">
		...
		<xsl:choose>
			...
			<xsl:when test="(@display-inline='yes-display-inline'  or not(@display-inline) ) and      ((parent::section/@display-inline='yes-display-inline'  or parent::section/enum or parent::section/header) or     (parent::subsection/@display-inline='yes-display-inline'  or parent::subsection/enum or parent::subsection/header) or     (parent::paragraph/@display-inline='yes-display-inline'  or parent::paragraph/enum or parent::paragraph/header) or     (parent::subparagraph/@display-inline='yes-display-inline'  or parent::subparagraph/enum or parent::paragraph/header) or     (parent::item/@display-inline='yes-display-inline'  or parent::item/enum or parent::item/header) or     (parent::subitem/@display-inline='yes-display-inline'  or parent::subitem/enum or parent::subitem/header)  or     (parent::clause/@display-inline='yes-display-inline'  or parent::clause/enum or parent::clause/header) or     (parent::subclause/@display-inline='yes-display-inline'  or parent::subclause/enum or parent::subclause/header)) or      (parent::amendment-block/@display-inline='yes-display-inline')">
			...
			<xsl:when test="parent::section/@display-inline='yes-display-inline' or parent::section/@section-type='resolved'">
			...
			<xsl:when test="parent::section/@display-inline='no-display-inline' and     not(following-sibling::quoted-block[@display-inline='yes-display-inline']) and $billType='appropriations'  ">
				<!-- TB  28Apr2009 -->				
					<xsl:call-template name="ActualPrintText"/>				
			</xsl:when>	
			<xsl:when test="parent::section/@display-inline='no-display-inline' and     not(following-sibling::quoted-block[@display-inline='yes-display-inline'])   ">
			...
			<xsl:when test="parent::amendment-instruction or parent::committee-report-para or parent::committee-report-subpara or parent::committee-report-segment">
				<xsl:choose>
					<xsl:when test="(local-name(preceding-sibling::*[1] )= 'committee-report-header' or local-name(preceding-sibling::*[1])='enum') and @display-inline='no-display-inline'">
						<p align="justify" class="indent">
							<xsl:call-template name="ActualPrintText"/>
						</p>
					</xsl:when>
					<xsl:when test="local-name(preceding-sibling::*[1] )= 'committee-report-header' or local-name(preceding-sibling::*[1])='enum'">
						<span align="justify" class="indent">
							<xsl:call-template name="ActualPrintText"/>
						</span>
						<xsl:if test="not(following-sibling::*)">
					...
					<xsl:when test="(local-name(preceding-sibling::*[1] )= 'text'  or local-name(preceding-sibling::*[1] )= 'committee-report-para' ) ">
						<div align="justify" class="indent">
							<xsl:call-template name="ActualPrintText"/>
						</div>
						<xsl:if test="not(following-sibling::*)">
					...
					<xsl:when test="parent::committee-report-para and ancestor::committee-report-segment">
						<div align="justify" class="indent">
							<xsl:call-template name="ActualPrintText"/>
						</div>
					...
					<xsl:when test="parent::amendment-instruction">
						...
						<xsl:call-template name="InsertBlankLines">
							<xsl:with-param name="aLinesNumber">
								<xsl:choose>
									<xsl:when test="parent::amendment-instruction/@blank-lines-after">
										<xsl:value-of select="parent::amendment-instruction/@blank-lines-after"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:text>1</xsl:text>
									</xsl:otherwise>
						...
						<xsl:if test="not(parent::amendment-instruction/following-sibling::*) and not(parent::amendment-instruction/parent::amendment/following-sibling::*) ">
							<p/>
						</xsl:if>
					</xsl:when>	
					<xsl:when test="(parent::committee-report-para or parent::committee-report-segment) and //amendment-doc ">
						<!-- TB 12Dec12 BugFixing #1287 -->
						<table width="80%" border="0" align="center" class="lbexSmallText">
							<tr>
								<td class="indent">
									<p align="justify" class="indent">
										<xsl:call-template name="ActualPrintText"/>
			...
			<xsl:when test="@display-inline='yes-display-inline' and contains(local-name(parent::*), 'rules' )">
				<xsl:apply-templates/>
			</xsl:when>
	...
	<xsl:template name="displaySubsection">
		...
		<xsl:choose>
			...
			<xsl:when test="(ancestor::quoted-block/@style='other' and ancestor::quoted-block/@other-style='archaic' )">
				<!-- TB 17Aug2009 Added new condition about preceding-sebling::subsection -->
				<xsl:if test="header and (not(parent::section or parent::quoted-block/parent::section) or (preceding-sibling::subsection))">
					<p>
						<center>
							<span class="initialcapArchaic">
								<xsl:call-template name="openQuotes"/>
				...
				<p align="justify" class="indentSubsection">
					...
					<xsl:for-each select="child::*">
						<xsl:choose>
							<xsl:when test="local-name() = 'enum' or local-name() = 'text' or local-name()='header'">
								<!-- nothing -->
							</xsl:when>
			...
			<xsl:when test="parent::quoted-block[@display-inline='yes-display-inline']/parent::subparagraph">				
				<p align="justify" class="indentSubpar">
					<xsl:call-template name="printQuotedText"/>
				</p>				
			</xsl:when>
			<xsl:when test="parent::quoted-block[@display-inline='yes-display-inline']/parent::clause">				
				<p align="justify" class="indentClause">
					<xsl:call-template name="printQuotedText"/>
				</p>				
			</xsl:when>
			<xsl:when test="parent::quoted-block[@display-inline='yes-display-inline']/parent::subclause">				
			...
			<xsl:when test="parent::quoted-block[@display-inline='yes-display-inline']/parent::subitem">				
			...
			<xsl:when test="parent::section/@section-type='undesignated-section' and $billType='traditional'">
				<xsl:apply-templates/>
			</xsl:when>
			<xsl:when test="./@indent='down1'">				
				<p align="justify" class="indentSubsection">
			...
			<xsl:when test="(parent::section and child::enum='' and child::text/@display-inline='yes-display-inline')   or (parent::section and child::enum=not('') and child::text/@display-inline='yes-display-inline' and   $billType='traditional' and position()=1)">
				<xsl:call-template name="ActualPrintSubsection"/>
			</xsl:when>
			<xsl:when test="parent::section and child::enum=not('') and child::text/@display-inline='yes-display-inline'">
				<xsl:call-template name="ActualPrintSubsection"/>
			</xsl:when>
	...
	<xsl:template match="paragraph">		
		<xsl:choose>
			...
			<xsl:when test="(./@reported-display-style='parentheses-boldface-italic') or    (./@reported-display-style='parentheses-boldface-roman') or    (./@reported-display-style='brackets-boldface-italic') or    (./@reported-display-style='brackets-boldface-roman')">
				<!--ul-->
				<p align="justify" class="indentSubsection">
					<xsl:apply-templates/>
				</p>
	...
	<xsl:template name="getAncDisplayStyle">
		...
		<xsl:choose>
			...
			<!-- ******************************************************************************** -->			
			<xsl:when test="parent::*/@reported-display-style and parent::*/@reported-display-style != ''">
				<xsl:value-of select="parent::*/@reported-display-style"/>
			</xsl:when>
			<xsl:when test="parent::*/@deleted-display-style and parent::*/@deleted-display-style != ''">
			...
			<!-- ******************************************************************************** -->
			<xsl:when test="ancestor::*[2]/@reported-display-style and ancestor::*[2]/@reported-display-style != ''">
				<xsl:value-of select="ancestor::*[2]/@reported-display-style"/>
			</xsl:when>
			<xsl:when test="ancestor::*[2]/@deleted-display-style and ancestor::*[2]/@deleted-display-style != ''">
				<xsl:value-of select="ancestor::*[2]/@deleted-display-style"/>
			</xsl:when>
			<xsl:when test="ancestor::*[2]/@added-display-style and ancestor::*[2]/@added-display-style != ''">
			...
			<!-- ******************************************************************************** -->
			<xsl:when test="ancestor::*[3]/@reported-display-style and ancestor::*[3]/@reported-display-style != ''">
				<xsl:value-of select="ancestor::*[3]/@reported-display-style"/>
			</xsl:when>
			<xsl:when test="ancestor::*[3]/@deleted-display-style and ancestor::*[3]/@deleted-display-style != ''">
				<xsl:value-of select="ancestor::*[3]/@deleted-display-style"/>
			</xsl:when>
			<xsl:when test="ancestor::*[3]/@added-display-style and ancestor::*[3]/@added-display-style != ''">
			...
			<!-- ******************************************************************************** -->
			<xsl:when test="ancestor::*[4]/@reported-display-style and ancestor::*[4]/@reported-display-style != ''">
				<xsl:value-of select="ancestor::*[4]/@reported-display-style"/>
			</xsl:when>
			<xsl:when test="ancestor::*[4]/@deleted-display-style and ancestor::*[4]/@deleted-display-style != ''">
				<xsl:value-of select="ancestor::*[4]/@deleted-display-style"/>
			</xsl:when>
			<xsl:when test="ancestor::*[4]/@added-display-style and ancestor::*[4]/@added-display-style != ''">
	...
	<xsl:template name="zeroindentlevel">
		...
		<xsl:choose>
			<xsl:when test="$aLevelToIndent='indentParagraph' or $aLevelToIndent='indentSubpar' or     $aLevelToIndent='indentClause' or $aLevelToIndent='indentSubclause' or     $aLevelToIndent='indentItem' or $aLevelToIndent='indentSubItem'">
			...
			<xsl:otherwise>
				...
				<xsl:variable name="bringIndentToZeroAttr">
					<xsl:call-template name="zeroindentlevel">
						<xsl:with-param name="aLevelToIndent">indentSubsection</xsl:with-param>
					</xsl:call-template>
				</xsl:variable>
				<p>
					<xsl:attribute name="style">
					...
					<xsl:choose>
						...
						<xsl:when test="parent::quoted-block[@display-inline='yes-display-inline']/parent::paragraph">
							<!--p align="justify" class="indent"-->
							<p align="justify" class="indentSubsection">
								<xsl:if test="$appropReportedStyle='bold-brackets' or @commented='yes'">
									<span class="brakets">
						...
						<xsl:when test="(ancestor::subparagraph/quoted-block or parent::quoted-block[@style='OLC']/parent::paragraph)">
							<!--p align="justify" class="indent"-->
							<p align="justify" class="indentSubsection">
								<xsl:if test="$appropReportedStyle='bold-brackets' or @commented='yes'">
									<span class="brakets">
	...
	<xsl:template match="subparagraph">
		<xsl:choose>
			...
			<xsl:when test="@deleted-display-style='italic' or   @reported-display-style='italic'">
				<i>
					<xsl:call-template name="displaySubparagraph"/>
				</i>
			</xsl:when>
	...
	<xsl:template name="defineIndentationParagraph">
		...
		<xsl:choose>
			<xsl:when test="preceding-sibling::paragraph/@display-inline='yes-display-inline' and parent::subsection">
	...
	<xsl:template name="defineIndentationParagraphByParent">
		<!--I am a paragraph element-->
		<xsl:choose>
			<xsl:when test="parent::*/preceding-sibling::paragraph/@display-inline='yes-display-inline' and ancestor::*[2]/subsection">
				<xsl:text>indentSubsection</xsl:text>
			</xsl:when>
			<xsl:when test="./@indent='up1' or ../@indent='up1'">
				<xsl:text>indentSubsection</xsl:text>
	...
	<xsl:template name="defineIndentationSubParagraph">
		...
		<xsl:choose>
			<xsl:when test="(preceding-sibling::subparagraph[@display-inline='yes-display-inline']) and not(parent::paragraph/@display-inline ='yes-display-inline') and not (parent::paragraph/@indent ='up1')">
				<xsl:text>indentParagraph</xsl:text>
			</xsl:when>
			<xsl:when test="(preceding-sibling::subparagraph[@display-inline='yes-display-inline']) and (parent::paragraph/@display-inline ='yes-display-inline' or parent::paragraph/@indent ='up1')">
				<xsl:text>indentSubsection</xsl:text>
			</xsl:when>
			<xsl:when test="preceding-sibling::subparagraph[@indent='up1'] or @indent='up1' or ./@indent='up1'">
				<xsl:text>indentParagraph</xsl:text>
			</xsl:when>
			<xsl:when test="preceding-sibling::subparagraph[@indent='up2'] or @indent='up2' or ./@indent='up2'">
				<xsl:text>indentSubsection</xsl:text>
			</xsl:when>
	...
	<xsl:template name="defineIndentationSubParagraphByParent">
		<!--I am a subparagraph element-->
		<xsl:choose>
			<xsl:when test="(parent::*/preceding-sibling::subparagraph[@display-inline='yes-display-inline']) and not(ancestor::*[2]/paragraph/@display-inline ='yes-display-inline') and not (ancestor::*[2]/paragraph/@indent ='up1')">
				<xsl:text>indentParagraph</xsl:text>
			</xsl:when>
			<xsl:when test="(parent::*/preceding-sibling::subparagraph[@display-inline='yes-display-inline']) and (ancestor::*[2]/paragraph/@display-inline ='yes-display-inline' or ancestor::*[2]/paragraph/@indent ='up1')">
				<xsl:text>indentSubsection</xsl:text>
			</xsl:when>
			<xsl:when test="parent::*/preceding-sibling::subparagraph[@indent='up1'] or ./@indent='up1' or ../@indent='up1'">
				<xsl:text>indentParagraph</xsl:text>
			</xsl:when>
			<xsl:when test="parent::*/preceding-sibling::subparagraph[@indent='up2'] or ./@indent='up2' or ../@indent='up2'">
				<xsl:text>indentSubsection</xsl:text>
			</xsl:when>
	...
	<xsl:template name="defineIndentationClause">
		...
		<xsl:choose>
			<xsl:when test="(preceding-sibling::clause[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '0'">
				<xsl:text>indentSubpar</xsl:text>
			</xsl:when>
			<xsl:when test="(preceding-sibling::clause[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '1'">
				<xsl:text>indentParagraph</xsl:text>
			</xsl:when>
			<xsl:when test="(preceding-sibling::clause[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '2'">
				<xsl:text>indentSubsection</xsl:text>
			</xsl:when>
			<!-- ************************************************** -->
			...
			<!--**************************************************-->
			<xsl:when test="preceding-sibling::clause[@indent='up1'] or @indent='up1' or ./@indent='up1'">
				<xsl:text>indentSubPar</xsl:text>
			</xsl:when>
			<xsl:when test="preceding-sibling::clause[@indent='up2'] or @indent='up2' or ./@indent='up2'">
				<xsl:text>indentParagraph</xsl:text>
			</xsl:when>
			<xsl:when test="preceding-sibling::clause[@indent='up3'] or @indent='up3' or ./@indent='up3'">
				<xsl:text>indentSubsection</xsl:text>
			</xsl:when>
			<!--**************************************************-->
	...
	<xsl:template name="defineIndentationClauseByParent">
		...
		<xsl:choose>
			<xsl:when test="(parent::*/preceding-sibling::clause[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '0'">
				<xsl:text>indentSubpar</xsl:text>
			</xsl:when>
			<xsl:when test="(parent::*/preceding-sibling::clause[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '1'">
				<xsl:text>indentParagraph</xsl:text>
			</xsl:when>
			<xsl:when test="(parent::*/preceding-sibling::clause[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '2'">
				<xsl:text>indentSubsection</xsl:text>
			</xsl:when>
			<!-- ************************************************** -->
			<xsl:when test="$parentDisplayInLineCount = '1' ">
			...
			<!--**************************************************-->
			<xsl:when test="parent::*/preceding-sibling::clause[@indent='up1'] or ./@indent='up1' or ../@indent='up1'">
				<xsl:text>indentSubPar</xsl:text>
			</xsl:when>
			<xsl:when test="parent::*/preceding-sibling::clause[@indent='up2'] or ./@indent='up2' or ../@indent='up2'">
				<xsl:text>indentParagraph</xsl:text>
			</xsl:when>
			<xsl:when test="parent::*/preceding-sibling::clause[@indent='up3'] or ./@indent='up3' or ../@indent='up3'">
				<xsl:text>indentSubsection</xsl:text>
			</xsl:when>
			<!--**************************************************-->
	...
	<xsl:template name="defineIndentationSubclause">
		...
		<xsl:choose>
			<xsl:when test="(preceding-sibling::subclause[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '0'">
				<xsl:text>indentClause</xsl:text>
			</xsl:when>
			<xsl:when test="(preceding-sibling::subclause[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '1'">
				<xsl:text>indentSubpar</xsl:text>
			</xsl:when>
			<xsl:when test="(preceding-sibling::subclause[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '2'">
				<xsl:text>indentParagraph</xsl:text>
			</xsl:when>
			<xsl:when test="(preceding-sibling::subclause[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '3'">
				<xsl:text>indentSubsection</xsl:text>
			</xsl:when>
			<!-- ************************************************** -->
			<xsl:when test="$parentDisplayInLineCount = '1' ">
			...
			<!--**************************************************-->
			<xsl:when test="preceding-sibling::subclause[@indent='up1'] or @indent='up1' or ./@indent='up1'">
				<xsl:text>indentClause</xsl:text>
			</xsl:when>
			<xsl:when test="preceding-sibling::subclause[@indent='up2'] or @indent='up2' or ./@indent='up2'">
				<xsl:text>indentSubPar</xsl:text>
			</xsl:when>
			<xsl:when test="preceding-sibling::subclause[@indent='up3'] or @indent='up3' or ./@indent='up3'">
				<xsl:text>indentParagraph</xsl:text>
			</xsl:when>
			<xsl:when test="preceding-sibling::subclause[@indent='up4'] or @indent='up4' or ./@indent='up4'">
				<xsl:text>indentSubsection</xsl:text>
			</xsl:when>
			<!--**************************************************-->
	...
	<xsl:template name="defineIndentationSubclauseByParent">
		...
		<xsl:choose>
			<xsl:when test="(parent::*/preceding-sibling::subclause[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '0'">
				<xsl:text>indentClause</xsl:text>
			</xsl:when>
			<xsl:when test="(parent::*/preceding-sibling::subclause[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '1'">
				<xsl:text>indentSubpar</xsl:text>
			</xsl:when>
			<xsl:when test="(parent::*/preceding-sibling::subclause[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '2'">
				<xsl:text>indentParagraph</xsl:text>
			</xsl:when>
			<xsl:when test="(parent::*/preceding-sibling::subclause[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '3'">
				<xsl:text>indentSubsection</xsl:text>
			</xsl:when>
			<!-- ************************************************** -->
			<xsl:when test="$parentDisplayInLineCount = '1' ">
			...
			<!--**************************************************-->
			<xsl:when test="parent::*/preceding-sibling::subclause[@indent='up1'] or ./@indent='up1' or ../@indent='up1'">
				<xsl:text>indentClause</xsl:text>
			</xsl:when>
			<xsl:when test="parent::*/preceding-sibling::subclause[@indent='up2'] or ./@indent='up2' or ../@indent='up2'">
				<xsl:text>indentSubPar</xsl:text>
			</xsl:when>
			<xsl:when test="parent::*/preceding-sibling::subclause[@indent='up3'] or ./@indent='up3' or ../@indent='up3'">
				<xsl:text>indentParagraph</xsl:text>
			</xsl:when>
			<xsl:when test="parent::*/preceding-sibling::subclause[@indent='up4'] or ./@indent='up4' or ../@indent='up4'">
				<xsl:text>indentSubsection</xsl:text>
			</xsl:when>
			<!--**************************************************-->
	...
	<xsl:template name="defineIndentationItem">
		...
		<xsl:choose>
			<xsl:when test="(preceding-sibling::item[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '0'">
				<xsl:text>indentSubclause</xsl:text>
			</xsl:when>
			<xsl:when test="(preceding-sibling::item[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '1'">
				<xsl:text>indentClause</xsl:text>
			</xsl:when>
			<xsl:when test="(preceding-sibling::item[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '2'">
				<xsl:text>indentSubpar</xsl:text>
			</xsl:when>
			<xsl:when test="(preceding-sibling::item[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '3'">
				<xsl:text>indentParagraph</xsl:text>
			</xsl:when>
			<xsl:when test="(preceding-sibling::item[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '4'">
				<xsl:text>indentSubsection</xsl:text>
			</xsl:when>
			<!-- ************************************************** -->
			<xsl:when test="$parentDisplayInLineCount = '1' ">
			...
			<!--**************************************************-->
			<xsl:when test="preceding-sibling::item[@indent='up1'] or @indent='up1' or ./@indent='up1'">
				<xsl:text>indentSubclause</xsl:text>
			</xsl:when>
			<xsl:when test="preceding-sibling::item[@indent='up2'] or @indent='up2' or ./@indent='up2'">
				<xsl:text>indentClause</xsl:text>
			</xsl:when>
			<xsl:when test="preceding-sibling::item[@indent='up3'] or @indent='up3' or ./@indent='up3'">
				<xsl:text>indentSubPar</xsl:text>
			</xsl:when>
			<xsl:when test="preceding-sibling::item[@indent='up4'] or @indent='up4' or ./@indent='up4'">
				<xsl:text>indentParagraph</xsl:text>
			</xsl:when>
			<xsl:when test="preceding-sibling::item[@indent='up5'] or @indent='up5' or ./@indent='up5'">
				<xsl:text>indentSubsection</xsl:text>
			</xsl:when>
			<!--**************************************************-->
	...
	<xsl:template name="defineIndentationItemByParent">
		...
		<xsl:choose>
			<xsl:when test="(parent::*/preceding-sibling::item[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '0'">
				<xsl:text>indentSubclause</xsl:text>
			</xsl:when>
			<xsl:when test="(parent::*/preceding-sibling::item[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '1'">
				<xsl:text>indentClause</xsl:text>
			</xsl:when>
			<xsl:when test="(parent::*/preceding-sibling::item[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '2'">
				<xsl:text>indentSubpar</xsl:text>
			</xsl:when>
			<xsl:when test="(parent::*/preceding-sibling::item[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '3'">
				<xsl:text>indentParagraph</xsl:text>
			</xsl:when>
			<xsl:when test="(parent::*/preceding-sibling::item[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '4'">
				<xsl:text>indentSubsection</xsl:text>
			</xsl:when>
			<!-- ************************************************** -->
			<xsl:when test="$parentDisplayInLineCount = '1' ">
			...
			<!--**************************************************-->
			<xsl:when test="parent::*/preceding-sibling::item[@indent='up1'] or ./@indent='up1' or ../@indent='up1'">
				<xsl:text>indentSubclause</xsl:text>
			</xsl:when>
			<xsl:when test="parent::*/preceding-sibling::item[@indent='up2'] or ./@indent='up2' or ../@indent='up2'">
				<xsl:text>indentClause</xsl:text>
			</xsl:when>
			<xsl:when test="parent::*/preceding-sibling::item[@indent='up3'] or ./@indent='up3' or ../@indent='up3'">
				<xsl:text>indentSubPar</xsl:text>
			</xsl:when>
			<xsl:when test="parent::*/preceding-sibling::item[@indent='up4'] or ./@indent='up4' or ../@indent='up4'">
				<xsl:text>indentParagraph</xsl:text>
			</xsl:when>
			<xsl:when test="parent::*/preceding-sibling::item[@indent='up5'] or ./@indent='up5' or ../@indent='up5'">
				<xsl:text>indentSubsection</xsl:text>
			</xsl:when>
			<!--**************************************************-->
	...
	<xsl:template name="defineIndentationSubitem">
		...
		<xsl:choose>
			<xsl:when test="(preceding-sibling::subitem[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '0'">
				<xsl:text>indentItem</xsl:text>
			</xsl:when>
			<xsl:when test="(preceding-sibling::subitem[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '1'">
				<xsl:text>indentSubclause</xsl:text>
			</xsl:when>
			<xsl:when test="(preceding-sibling::subitem[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '2'">
				<xsl:text>indentClause</xsl:text>
			</xsl:when>
			<xsl:when test="(preceding-sibling::subitem[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '3'">
				<xsl:text>indentSubpar</xsl:text>
			</xsl:when>
			<xsl:when test="(preceding-sibling::subitem[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '4' and not(parent::item/@display-inline= 'yes-display-inline')">
				<xsl:text>indentSubpar</xsl:text>
			</xsl:when>
			<xsl:when test="(preceding-sibling::subitem[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '4'">
				<xsl:text>indentParagraph</xsl:text>
			</xsl:when>
			<xsl:when test="(preceding-sibling::subitem[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '5'">
				<xsl:text>indentSubsection</xsl:text>
			</xsl:when>
			<!-- ************************************************** -->
			<xsl:when test="$parentDisplayInLineCount = '1' ">
			...
			<!--**************************************************-->
			<xsl:when test="preceding-sibling::subitem[@indent='up1'] or @indent='up1' or ./@indent='up1'">
				<xsl:text>indentItem</xsl:text>
			</xsl:when>
			<xsl:when test="preceding-sibling::subitem[@indent='up2'] or @indent='up2' or ./@indent='up2'">
				<xsl:text>indentSubclause</xsl:text>
			</xsl:when>
			<xsl:when test="preceding-sibling::subitem[@indent='up3'] or @indent='up3' or ./@indent='up3'">
				<xsl:text>indentClause</xsl:text>
			</xsl:when>
			<xsl:when test="preceding-sibling::subitem[@indent='up4'] or @indent='up4' or ./@indent='up4'">
				<xsl:text>indentSubPar</xsl:text>
			</xsl:when>
			<xsl:when test="preceding-sibling::subitem[@indent='up5'] or @indent='up5' or ./@indent='up5'">
				<xsl:text>indentParagraph</xsl:text>
			</xsl:when>
			<xsl:when test="preceding-sibling::subitem[@indent='up6'] or @indent='up6' or ./@indent='up6'">
				<xsl:text>indentSubsection</xsl:text>
			</xsl:when>
			<!--**************************************************-->
	...
	<xsl:template name="defineIndentationSubitemByParent">
		...
		<xsl:choose>
			<xsl:when test="(parent::*/preceding-sibling::subitem[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '0'">
				<xsl:text>indentItem</xsl:text>
			</xsl:when>
			<xsl:when test="(parent::*/preceding-sibling::subitem[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '1'">
				<xsl:text>indentSubclause</xsl:text>
			</xsl:when>
			<xsl:when test="(parent::*/preceding-sibling::subitem[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '2'">
				<xsl:text>indentClause</xsl:text>
			</xsl:when>
			<xsl:when test="(parent::*/preceding-sibling::subitem[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '3'">
				<xsl:text>indentSubpar</xsl:text>
			</xsl:when>
			<xsl:when test="(parent::*/preceding-sibling::subitem[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '4' and not(parent::item/@display-inline= 'yes-display-inline')">
				<xsl:text>indentSubpar</xsl:text>
			</xsl:when>
			<xsl:when test="(parent::*/preceding-sibling::subitem[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '4'">
				<xsl:text>indentParagraph</xsl:text>
			</xsl:when>
			<xsl:when test="(parent::*/preceding-sibling::subitem[@display-inline='yes-display-inline']) and $parentDisplayInLineCount = '5'">
				<xsl:text>indentSubsection</xsl:text>
			</xsl:when>
			<!-- ************************************************** -->
			<xsl:when test="$parentDisplayInLineCount = '1' ">
			...
			<!--**************************************************-->
			<xsl:when test="parent::*/preceding-sibling::subitem[@indent='up1'] or @indent='up1' or ./@indent='up1'">
				<xsl:text>indentItem</xsl:text>
			</xsl:when>
			<xsl:when test="parent::*/preceding-sibling::subitem[@indent='up2'] or @indent='up2' or ./@indent='up2'">
				<xsl:text>indentSubclause</xsl:text>
			</xsl:when>
			<xsl:when test="parent::*/preceding-sibling::subitem[@indent='up3'] or @indent='up3' or ./@indent='up3'">
				<xsl:text>indentClause</xsl:text>
			</xsl:when>
			<xsl:when test="parent::*/preceding-sibling::subitem[@indent='up4'] or @indent='up4' or ./@indent='up4'">
				<xsl:text>indentSubPar</xsl:text>
			</xsl:when>
			<xsl:when test="parent::*/preceding-sibling::subitem[@indent='up5'] or @indent='up5' or ./@indent='up5'">
				<xsl:text>indentParagraph</xsl:text>
			</xsl:when>
			<xsl:when test="parent::*/preceding-sibling::subitem[@indent='up6'] or @indent='up6' or ./@indent='up6'">
				<xsl:text>indentSubsection</xsl:text>
			</xsl:when>
			<!--**************************************************-->
	...
	<xsl:template name="countParentDisplayInlineMax2">
		<xsl:variable name="anc1_up_level">
			<xsl:choose>
				<xsl:when test="ancestor::*[1]/@indent and not (ancestor::*[2]/@display-inline = 'yes-display-inline')">
					<xsl:value-of select="substring-after(ancestor::*[1]/@indent, 'up')"/>
				</xsl:when>
				<xsl:when test="ancestor::*[1]/@indent and ancestor::*[2]/@display-inline = 'yes-display-inline'">
		...
		<xsl:variable name="anc2_up_level">
			<xsl:choose>
				<xsl:when test="ancestor::*[2]/@indent and not (ancestor::*[3]/@display-inline = 'yes-display-inline')">
					<xsl:value-of select="substring-after(ancestor::*[2]/@indent, 'up')"/>
				</xsl:when>
				<xsl:when test="ancestor::*[2]/@indent and ancestor::*[3]/@display-inline = 'yes-display-inline'">
		...
		<xsl:choose>
			<xsl:when test="((ancestor::*[1]/@display-inline='yes-display-inline'  and not(local-name(ancestor::*[1]) = 'quoted-block')) or     ancestor::*[1]/preceding-sibling::item/@display-inline='yes-display-inline' or      ancestor::*[1]/preceding-sibling::subclause/@display-inline='yes-display-inline' or      ancestor::*[1]/preceding-sibling::clause/@display-inline='yes-display-inline' or      ancestor::*[1]/preceding-sibling::subparagraph/@display-inline='yes-display-inline' or      ancestor::*[1]/preceding-sibling::paragraph/@display-inline='yes-display-inline' )     and (ancestor::*[2]/@display-inline='yes-display-inline' or     ancestor::*[2]/preceding-sibling::item/@display-inline='yes-display-inline' or      ancestor::*[2]/preceding-sibling::subclause/@display-inline='yes-display-inline' or      ancestor::*[2]/preceding-sibling::clause/@display-inline='yes-display-inline' or      ancestor::*[2]/preceding-sibling::subparagraph/@display-inline='yes-display-inline' or      ancestor::*[2]/preceding-sibling::paragraph/@display-inline='yes-display-inline' ) ">
			...
			<xsl:when test="((ancestor::*[2]/@display-inline='yes-display-inline'   and not(local-name(ancestor::*[2]) = 'quoted-block')) or     ancestor::*[2]/preceding-sibling::item/@display-inline='yes-display-inline' or      ancestor::*[2]/preceding-sibling::subclause/@display-inline='yes-display-inline' or      ancestor::*[2]/preceding-sibling::clause/@display-inline='yes-display-inline' or      ancestor::*[2]/preceding-sibling::subparagraph/@display-inline='yes-display-inline' or      ancestor::*[2]/preceding-sibling::paragraph/@display-inline='yes-display-inline' )">
	...
	<xsl:template name="countParentDisplayInlineMax3">
		...
		<xsl:variable name="anc3_up_level">
			<xsl:choose>
				<xsl:when test="ancestor::*[3]/@indent and not(ancestor::*[4]/@display-inline = 'yes-display-inline')">
					<xsl:value-of select="substring-after(ancestor::*[3]/@indent, 'up')"/>
				</xsl:when>
				<xsl:when test="ancestor::*[3]/@indent and ancestor::*[4]/@display-inline = 'yes-display-inline'">
		...
		<xsl:choose>
			<xsl:when test="(ancestor::*[3]/@display-inline='yes-display-inline'  and not(local-name(ancestor::*[3]) = 'quoted-block')) or      ancestor::*[3]/preceding-sibling::item/@display-inline='yes-display-inline' or      ancestor::*[3]/preceding-sibling::subclause/@display-inline='yes-display-inline' or      ancestor::*[3]/preceding-sibling::clause/@display-inline='yes-display-inline' or      ancestor::*[3]/preceding-sibling::subparagraph/@display-inline='yes-display-inline' or      ancestor::*[3]/preceding-sibling::paragraph/@display-inline='yes-display-inline' ">
	...
	<xsl:template name="countParentDisplayInlineMax4">
		...
		<xsl:variable name="anc4_up_level">
			<xsl:choose>
				<xsl:when test="ancestor::*[4]/@indent and not (ancestor::*[5]/@display-inline = 'yes-display-inline')">
					<xsl:value-of select="substring-after(ancestor::*[4]/@indent, 'up')"/>
				</xsl:when>
				<xsl:when test="ancestor::*[4]/@indent and ancestor::*[5]/@display-inline = 'yes-display-inline'">
		...
		<xsl:choose>
			<xsl:when test="ancestor::*[4]/@display-inline='yes-display-inline' or     ancestor::*[4]/preceding-sibling::item/@display-inline='yes-display-inline' or      ancestor::*[4]/preceding-sibling::subclause/@display-inline='yes-display-inline' or      ancestor::*[4]/preceding-sibling::clause/@display-inline='yes-display-inline' or      ancestor::*[4]/preceding-sibling::subparagraph/@display-inline='yes-display-inline' or      ancestor::*[4]/preceding-sibling::paragraph/@display-inline='yes-display-inline'  ">
	...
	<xsl:template name="countParentDisplayInlineMax5">
		...
		<xsl:variable name="anc5_up_level">
			<xsl:choose>
				<xsl:when test="ancestor::*[5]/@indent and not (ancestor::*[6]/@display-inline = 'yes-display-inline')">
					<xsl:value-of select="substring-after(ancestor::*[5]/@indent, 'up')"/>
				</xsl:when>
				<xsl:when test="ancestor::*[5]/@indent and ancestor::*[6]/@display-inline = 'yes-display-inline'">
		...
		<xsl:choose>
			<xsl:when test="ancestor::*[5]/@display-inline='yes-display-in'  or     ancestor::*[5]/preceding-sibling::item/@display-inline='yes-display-inline' or      ancestor::*[5]/preceding-sibling::subclause/@display-inline='yes-display-inline' or      ancestor::*[5]/preceding-sibling::clause/@display-inline='yes-display-inline' or      ancestor::*[5]/preceding-sibling::subparagraph/@display-inline='yes-display-inline' or      ancestor::*[5]/preceding-sibling::paragraph/@display-inline='yes-display-inline' ">
	...
	<xsl:template name="ActualPrintSubParagraphWithText">
		<xsl:choose>
			<xsl:when test="local-name() = 'subparagraph'  and @indent='up1' or  parent::*/@indent = 'up1'">
				<p align="justify" class="indentParagraph">
					<xsl:call-template name="ActualPrintSubParagraphWithTextNoClass"/>
				</p>
			</xsl:when>
			<xsl:when test="local-name() = 'subparagraph'  and @indent='up2' or  parent::*/@indent = 'up2'">
				<p align="justify" class="indentSubsection">
					<xsl:call-template name="ActualPrintSubParagraphWithTextNoClass"/>
				</p>
			</xsl:when>
	...
	<xsl:template match="external-xref">
		<xsl:choose>
			<xsl:when test="./@legal-doc='usc-appendix'">
				<a>
					<xsl:attribute name="href">
						...
						<xsl:variable name="title" select="substring-before(substring-after(./@parsable-cite,'/'),'/')"/>
						<xsl:value-of select="$title"/>
						<xsl:text>&amp;section=</xsl:text>
						<xsl:variable name="usctitle" select="concat('usc-appendix/',$title,'/')"/>
						<xsl:choose>
							<xsl:when test="contains(./@parsable-cite,'(')">
								<xsl:value-of select="substring-before(substring-after(./@parsable-cite, $usctitle),'(')"/>
							</xsl:when>
							<xsl:otherwise>
			...
			<xsl:when test="./@legal-doc='usc-act'">
				<a>
					<xsl:attribute name="href">
						...
						<xsl:variable name="actname" select="substring-before(substring-after(./@parsable-cite,'/'),'/')"/>
						<xsl:value-of select="$actname"/>
						<xsl:text>&amp;section=</xsl:text>
						<xsl:value-of select="substring-after(substring-after(./@parsable-cite, $actname),'/')"/>
					</xsl:attribute>
					<xsl:apply-templates/>
				</a>
			</xsl:when>
			...
			<xsl:when test="./@legal-doc='public-law'">
				...
				<xsl:choose>
					<xsl:when test="number(substring-before(substring-after(./@parsable-cite,'pl/'),'/')) &gt; 103">
						<a>
							<xsl:attribute name="href">
								<xsl:text>http://frwebgate.access.gpo.gov/cgi-bin/getdoc.cgi?dbname=</xsl:text>
								<xsl:value-of select="substring-before(substring-after(./@parsable-cite,'pl/'), '/')"/>
								...
								<xsl:if test="number(substring-after(substring-after(./@parsable-cite,'pl/'),'/')) &gt;9 and     number(substring-after(substring-after(./@parsable-cite,'pl/'),'/')) &lt; 100">
									<xsl:text>0</xsl:text>
								</xsl:if>
								<xsl:value-of select="substring-after(substring-after(./@parsable-cite,'pl/'),'/')"/>
								<xsl:text>.</xsl:text>
								<xsl:value-of select="substring-before(substring-after(./@parsable-cite,'pl/'), '/')"/>
	...
	<xsl:template match="toc">
		...
		<xsl:choose>
			...
			<xsl:when test="multi-column-toc-entry">				
				<p class="tocsectionOLC" style="margin-left: -2em;">	
	...
	<xsl:template name="createLinkNoParam">
		...
		<xsl:if test="not(ancestor::quoted-block[@style='tax']) or (ancestor::quoted-block[@style='tax']  and  (@level='part' or @level='subpart' or @level='subchapter' or @level='section' ))">
			<!-- TB 12Sep2007  #717 -->
			<xsl:call-template name="displayTocVerticalSpace"/>
			<xsl:choose>
				<xsl:when test="not(@level='section'  or @level='subsection'  or @level='paragraph'   or @level='subparagraph'  or @level='clause'  or @level='subclause' or @level='item'  or @level='subitem'  )">
					<center>
		...
		<xsl:choose>
			<xsl:when test="$isIdReferenceExists='yes'">				
				<a>
					...
					<!-- TB 12Sep2007  #717 -->
					<xsl:if test="not(ancestor::quoted-block[@style='tax']) and (ancestor-or-self::toc-entry[1]/following-sibling::*) ">
						<xsl:call-template name="displayTocVerticalSpace"/>
					</xsl:if>
		...
		<a>
			...
			<xsl:choose>
				...
				<xsl:otherwise>
					...
					<xsl:if test="local-name(node()[position()=last()]) != '' or ( local-name(node()[position()=last()]) = '' and (node()[position()=last()] = '' or node()[position()=last()] = '.' or node()[position()=last()] = ';')) ">
						<xsl:call-template name="closeQuotesByCondition"/>
					</xsl:if>
					<!-- TB 12Sep2007  #717 -->
					<xsl:if test="not(ancestor::quoted-block[@style='tax']) and (ancestor-or-self::toc-entry[1]/following-sibling::*) ">
	...
	<xsl:template name="ActualCreateLinkNoRef">
		...
		<xsl:choose>
			<xsl:when test="@level='section'">
				<xsl:apply-templates/>
				<xsl:if test="(($appropReportedStyle='bold-brackets' and $isToCloseTheBrackets='yes' ) or @commented='yes') and not (local-name() = 'toc-entry')">
					<span class="brakets">
						<xsl:text>]</xsl:text>
					</span>
				</xsl:if>
	...
	<xsl:template match="toc-entry">		
		...
		<xsl:variable name="isPrintItalic">
			...
			<xsl:choose>
				...
				<xsl:when test="contains(ancestor::amendment-block/@reported-display-style,'italic')  and not (parent::toc/@chabged='not-changed') and not (@changed='not-changed')">
					<xsl:text>yes</xsl:text>
				</xsl:when>
				<xsl:otherwise>
					<xsl:text>no</xsl:text>
		...
		<xsl:variable name="isPrintIBold">
			<xsl:choose>		
				...
				<xsl:when test="contains(ancestor::amendment-block/@reported-display-style,'bold') and not (ancestor::amendment-block/@reported-display-style='bold-brackets')   and not (parent::toc/@chabged='not-changed') and not (@changed='not-changed')">
					<xsl:text>yes</xsl:text>
				</xsl:when>
				<xsl:otherwise>
					<xsl:text>no</xsl:text>
		...
		<xsl:variable name="isPrintStrikethrough">
			...
			<xsl:choose>
				...
				<xsl:when test="contains(ancestor::amendment-block/@reported-display-style,'strikethrough')  and not (parent::toc/@chabged='not-changed') and not (@changed='not-changed')">
					<xsl:text>yes</xsl:text>
				</xsl:when>
				<xsl:otherwise>
					<xsl:text>no</xsl:text>
		...
		<xsl:choose>
			<xsl:when test="$isPrintItalic='yes' and (parent::toc/parent::subparagraph/parent::paragraph)">
				<i>
			...
			<xsl:when test="$isPrintStrikethrough='yes' and (parent::toc/parent::subparagraph/parent::paragraph)">
				<strike>
					<xsl:if test="$isPrintIBold='yes' ">
						<xsl:attribute name="style">
							<xsl:text>font-weight: bold;</xsl:text>
	...
	<xsl:template name="actualCreateLinkWrapper">
		...
		<xsl:variable name="isPrintBracket">			
			<xsl:choose>		
				...
				<xsl:when test="contains(ancestor::amendment-block/@reported-display-style,'bracket')  and not (parent::toc/@chabged='not-changed') and not (@changed='not-changed')">
					<xsl:text>yes</xsl:text>
				</xsl:when>
		...
		<xsl:variable name="isPrintParentheses">			
			<xsl:choose>		
				...
				<xsl:when test="contains(ancestor::amendment-block/@reported-display-style,'parentheses')  and not (parent::toc/@chabged='not-changed') and not (@changed='not-changed')">
					<xsl:text>yes</xsl:text>
				</xsl:when>
				<xsl:otherwise>
					<xsl:text>no</xsl:text>
	...
	<xsl:template name="actualCreateLinkWrapperContent">
		...
		<xsl:if test="$isToCloseTheBrackets = 'yes' and $isPrintBracket='yes' and  ((following-sibling::toc-entry and not(contains(following-sibling::toc-entry/@reported-display-style, 'bracket')) and not (contains(parent::toc/@reported-display-style, 'bracket')) )  or  (local-name() = 'toc-entry' and not(following-sibling::*)))">
			<span class="brakets">
				<xsl:text>]</xsl:text>
			</span>
		</xsl:if>
		
		<xsl:if test="$isPrintParentheses='yes' and (following-sibling::toc-entry and not(contains(following-sibling::toc-entry/@reported-display-style, 'parentheses')) and not (contains(parent::toc/@reported-display-style, 'parentheses')) or  (local-name() = 'toc-entry' and not(following-sibling::*)))">
			<span class="brakets">
				<xsl:text>)</xsl:text>
			</span>
		</xsl:if>
	...
	<xsl:template name="TocEntryMainChoose">
		...
		<xsl:choose>			
			...
			<xsl:when test="$aCurrElementStyle='tax'">
				<xsl:choose>
					<xsl:when test="(@level='section' and ancestor::*[@reported-display-style='boldface-roman'])     or (@level='section' and ancestor::*[@reported-display-style='boldface-italic'])">
					...
					<xsl:when test="(@level='part' and ancestor::*[@reported-display-style='boldface-roman']) or     (@level='part' and ancestor::*[@reported-display-style='boldface-italic'])">
						<span align="justify" style="text-indent: 4em;">	
							<xsl:call-template name="createLinkWrapper">
					...
					<xsl:when test="(@level='chapter'  or @level='subchapter'  or @level='subtitle' ) and        (ancestor::*[@reported-display-style='boldface-roman'] or @level='chapter' and ancestor::*[@reported-display-style='boldface-italic']) ">
					...
					<xsl:when test="@level='title' or @level='subchapter' or @level='chapter' or @level='subtitle'">
	...
	<xsl:template match="quoted-block">		
		<xsl:choose>
			...
			<xsl:when test="(parent::subsection/preceding-sibling::subsection/quoted-block/paragraph/subparagraph)">
				<ul>
					<xsl:apply-templates/>
				</ul>
			</xsl:when>
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				...
				<p>
					...
					<xsl:choose>
						<!-- Check in aditional that this is the last element in deleted block -->
						<xsl:when test="($appropReportedStyle='bold-brackets' and $isToCloseTheBrackets='yes') or @commented='yes'">
							<span class="brakets">
								<xsl:text>]</xsl:text>
							</span>
						</xsl:when>
	...
	<xsl:template match="quote">
		<xsl:if test="local-name(preceding-sibling::*[1]) = 'deleted-phrase' and preceding-sibling::*[1]/@reported-display-style='bold-brackets'">
			<xsl:text> </xsl:text>
		</xsl:if>
		<xsl:choose>
	...
	<xsl:template match="enum-in-header">
		...
		<xsl:choose>
			<xsl:when test="parent::header-in-text[@level='section' or @level='division'     or @level='part' or @level='chapter' or @level='subpart' or @level='subchapter']">
				<span class="titlelevelOLC">
					<xsl:value-of select="."/>
				</span>
			</xsl:when>
			<xsl:when test="../parent::section and ../parent::section/header/enum-in-header and $currentElementStyle = 'tax'">
				<span class="smallcapUSC" style="font-weight:bold; text-transform:normal;font-variant: normal;">
					<xsl:value-of select="."/>
				</span>
			</xsl:when>
			<xsl:when test="../parent::section and ../parent::section/header/enum-in-header and $currentElementStyle = 'OLC'">
				<span class="sectionlevelOLC">
					<xsl:value-of select="."/>
				</span>
			</xsl:when>
			<xsl:when test="../parent::section and ../parent::section/header/enum-in-header and $currentElementStyle != 'traditional'">
			...
			<xsl:when test="$currentElementStyle='OLC' or  $currentElementStyle='traditional'  or $currentElementStyle='tax' or  $currentElementStyle='nuclear'  or  $currentElementStyle='traditional-inline' or  $currentElementStyle='archaic-paragraph'  ">
				<span style="text-transform:none;font-variant: normal;">
					<xsl:value-of select="."/>
				</span>
			</xsl:when>
	...
	<xsl:template match="first-page-header">
		<xsl:choose>
			...
			<xsl:otherwise>
				<xsl:if test="(@display='yes' or not(@display)) and not ($amendType='engrossed-amendment')">
					<!--xsl:if
	...
	<xsl:template match="first-page-desc" name="first-page-desc">
		<xsl:if test="(//first-page-desc/@display='yes' or not(//first-page-desc/@display)) and //first-page-desc/text() !=''">
			<center>
	...
	<xsl:template match="section[@display-inline='no-display-inline']/paragraph[@display-inline='no-display-inline']/quoted-block[@display-inline='no-display-inline' or not(@display-inline)]">
		<xsl:choose>
			<xsl:when test="@display-inline='yes-display-inline'">
				<xsl:text> “</xsl:text>
				<xsl:apply-templates/>
	...
	<xsl:template match="section/paragraph/subparagraph/quoted-block[@display-inline='yes-display-inline']">
		<!--xsl:text> “</xsl:text-->
		<xsl:text> </xsl:text>
		<xsl:apply-templates/>
	</xsl:template>
	...
	<xsl:template match="section/paragraph/subparagraph/clause/quoted-block[@display-inline='yes-display-inline']">
		<xsl:text> “</xsl:text>
		<xsl:apply-templates/>
	</xsl:template>
	...
	<xsl:template match="section/paragraph/subparagraph[@display-inline='yes-display-inline']/clause[@display-inline='yes-display-inline']/quoted-block">
		<ul>
			<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
		</ul>
	</xsl:template>
	...
	<xsl:template match="section/paragraph[@indent='up1']/subparagraph/clause[@indent='up1']/quoted-block">
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
	</xsl:template>
	...
	<xsl:template match="section/paragraph/subparagraph/clause/subclause/quoted-block[@display-inline='yes-display-inline']">
		<xsl:text> “</xsl:text>
		<xsl:apply-templates/>
	</xsl:template>
	<xsl:template match="section/paragraph/subparagraph/clause[@indent='up2']/subclause/quoted-block">
		<!--ul-->
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
		<!--/ul-->
	</xsl:template>
	<xsl:template match="section/paragraph/subparagraph[@indent='up1']/clause/subclause/quoted-block">
		<!--ul>
			<ul-->
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
		<!--/ul>
	...
	<xsl:template match="section/paragraph/subparagraph/clause/subclause[@indent='up4']/quoted-block">
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
	</xsl:template>
	<xsl:template match="section/paragraph/subparagraph/clause[@indent='up3']/subclause/quoted-block">
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
	</xsl:template>
	<xsl:template match="section/paragraph/subparagraph[@indent='up2']/clause/subclause/quoted-block">
		<!--ul-->
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
		<!--/ul-->
	</xsl:template>
	<xsl:template match="section/paragraph[@indent='up1']/subparagraph/clause/subclause/quoted-block">
		<!--ul>
			<ul-->
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
		<!--/ul>
	...
	<xsl:template match="section/paragraph[@indent='up1']/subparagraph/clause[@indent='up1']/subclause/quoted-block">
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
	</xsl:template>
	...
	<xsl:template match="section/paragraph/subparagraph/clause/subclause/item/quoted-block[@display-inline='yes-display-inline']">
		<xsl:text> “</xsl:text>
		<xsl:apply-templates/>
	</xsl:template>
	<xsl:template match="section/paragraph/subparagraph/clause/subclause/item[@indent='up5']/quoted-block">
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
	</xsl:template>
	<xsl:template match="section/paragraph/subparagraph/clause/subclause[@indent='up4']/item/quoted-block">
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
	</xsl:template>
	<xsl:template match="section/paragraph/subparagraph/clause[@indent='up3']/subclause/item/quoted-block">
		<!--ul-->
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
		<!--/ul-->
	</xsl:template>
	<xsl:template match="section/paragraph/subparagraph[@indent='up2']/clause/subclause/item/quoted-block">
		<!--ul>
			<ul-->
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
		<!--/ul>
	...
	<xsl:template match="section/paragraph/subparagraph[@indent='up1']/clause/subclause/item/quoted-block">
		<!--ul>
			<ul>
				<ul-->
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
	...
	<xsl:template match="section/paragraph/subparagraph[@indent='up2']/clause/subclause[@indent='up1']/item/quoted-block">
		<!--ul-->
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
		<!--/ul-->
	</xsl:template>
	<xsl:template match="section/paragraph[@indent='up1']/subparagraph/clause/subclause/item/quoted-block">
		<!--ul>
			<ul>
				<ul-->
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
	...
	<xsl:template match="section/paragraph[@indent='up1']/subparagraph/clause[@indent='up1']/subclause/item[@indent='up1']/quoted-block">
		<!--ul-->
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
		<!--/ul-->
	</xsl:template>
	...
	<xsl:template match="section/paragraph/subparagraph/clause/subclause/item/subitem/quoted-block[@display-inline='yes-display-inline']">
		<xsl:text> “</xsl:text>
		<xsl:apply-templates/>
	</xsl:template>
	<xsl:template match="section/paragraph/subparagraph/clause/subclause[@indent='up3']/item/subitem/quoted-block">		
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>		
	</xsl:template>
	<xsl:template match="section/paragraph/subparagraph[@indent='up1']/clause/subclause/item/subitem[@indent='up1']/quoted-block">		
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>		
	</xsl:template>
	<xsl:template match="section/paragraph/subparagraph/clause/subclause/item[@indent='up5']/subitem/quoted-block">
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
	</xsl:template>
	<xsl:template match="subsection/paragraph/subparagraph/clause/subclause[@indent='up4']/item/subitem/quoted-block">		
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>		
	</xsl:template>
	<xsl:template match="section/paragraph/subparagraph/clause[@indent='up3']/subclause/item/subitem/quoted-block">		
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>		
	</xsl:template>
	<xsl:template match="section/paragraph/subparagraph[@indent='up2']/clause/subclause/item/subitem/quoted-block">		
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>		
	</xsl:template>
	<xsl:template match="section/paragraph/subparagraph[@indent='up2']/clause/subclause/item/subitem[@indent='up1']/quoted-block">		
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>		
	</xsl:template>
	<xsl:template match="section/paragraph[@indent='up1']/subparagraph/clause/subclause/item/subitem/quoted-block">		
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>		
	</xsl:template>
	<xsl:template match="section/paragraph[@indent='up1']/subparagraph/clause[@indent='up1']/subclause/item[@indent='up1']/subitem/quoted-block">		
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>		
	</xsl:template>
	...
	<xsl:template match="subsection/paragraph/quoted-block">
		<xsl:choose>
			<xsl:when test="parent::paragraph[@display-inline='yes-display-inline'] and   not(child::section)">				
				<xsl:text> </xsl:text>
				<xsl:apply-templates/>
			</xsl:when>
			<xsl:when test="@display-inline='yes-display-inline'">				
	...
	<xsl:template match="subsection/paragraph/subparagraph[@display-inline='yes-display-inline']/clause[@display-inline='yes-display-inline']/quoted-block">		
		<p align="justify" class="indentClause">
			<xsl:apply-templates/>
		</p>		
	</xsl:template>
	...
	<xsl:template match="subsection/paragraph[@indent='up1']/subparagraph/clause[@indent='up1']/quoted-block">
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
	</xsl:template>
	...
	<xsl:template match="subsection/paragraph/subparagraph/clause[@indent='up2']/subclause/quoted-block">		
		<p class="indentSubclause" align="justify">
			<xsl:apply-templates/>
		</p>		
	</xsl:template>
	<xsl:template match="subsection/paragraph/subparagraph[@indent='up1']/clause/subclause/quoted-block">		
		<p class="indentSubclause" align="justify">
			<xsl:apply-templates/>
		</p>	
	</xsl:template>
	<xsl:template match="subsection/paragraph/subparagraph/clause/subclause[@indent='up4']/quoted-block">
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
	</xsl:template>
	<xsl:template match="subsection/paragraph/subparagraph/clause[@indent='up3']/subclause/quoted-block">
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
	</xsl:template>
	<xsl:template match="subsection/paragraph/subparagraph[@indent='up2']/clause/subclause/quoted-block">		
		<p class="indentSubclause">
			<xsl:apply-templates/>
		</p>		
	</xsl:template>
	<xsl:template match="subsection/paragraph[@indent='up1']/subparagraph/clause/subclause/quoted-block">
		<p class="indentSubclause">
			<xsl:apply-templates/>
		</p>	
	</xsl:template>
	<xsl:template match="subsection/paragraph[@indent='up1']/subparagraph/clause[@indent='up1']/subclause/quoted-block">
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
	</xsl:template>
	...
	<xsl:template match="subsection/paragraph/subparagraph/clause/subclause/item[@indent='up5']/quoted-block">
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
	</xsl:template>
	<xsl:template match="subsection/paragraph/subparagraph/clause/subclause[@indent='up4']/item/quoted-block">
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
	</xsl:template>
	<xsl:template match="subsection/paragraph/subparagraph/clause[@indent='up3']/subclause/item/quoted-block">		
		<p class="indentItem">
			<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
		</p>	
	</xsl:template>
	<xsl:template match="subsection/paragraph/subparagraph[@indent='up2']/clause/subclause/item/quoted-block">		
		<p class="indentItem">
			<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
		</p>		
	</xsl:template>
	<xsl:template match="subsection/paragraph/subparagraph[@indent='up1']/clause/subclause/item/quoted-block">		
		<p align="justify" class="indentItem">
			<xsl:apply-templates/>
		</p>	
	</xsl:template>
	<xsl:template match="subsection/paragraph/subparagraph[@indent='up2']/clause/subclause[@indent='up1']/item/quoted-block">		
		<p align="justify" class="indentSubclause">
			<xsl:apply-templates/>
		</p>		
	</xsl:template>
	<xsl:template match="subsection/paragraph[@indent='up1']/subparagraph/clause/subclause/item/quoted-block">		
		<p align="justify" class="indentItem">
			<xsl:apply-templates/>
		</p>		
	</xsl:template>
	<xsl:template match="subsection/paragraph[@indent='up1']/subparagraph/clause[@indent='up1']/subclause/item[@indent='up1']/quoted-block">		
		<p align="justify" class="indentItem">
			<xsl:apply-templates/>
		</p>		
	</xsl:template>
	<xsl:template match="subsection/paragraph/subparagraph/clause/subclause/item/subitem/quoted-block">
		<xsl:choose>
			<xsl:when test="@display-inline='yes-display-inline'">
				<xsl:text> “</xsl:text>
				<xsl:apply-templates/>
	...
	<xsl:template match="subsection/paragraph/subparagraph/clause/subclause[@indent='up3']/item/subitem/quoted-block">
		<!--ul>
			<ul-->
		<p align="justify" class="indentSubclause">
			<xsl:apply-templates/>
	...
	<xsl:template match="subsection/paragraph/subparagraph[@indent='up1']/clause/subclause/item/subitem[@indent='up1']/quoted-block">
		<!--ul>
			<ul>
				<ul>
					<ul-->
	...
	<xsl:template match="subsection/paragraph/subparagraph/clause/subclause/item[@indent='up5']/subitem/quoted-block">
		<xsl:call-template name="ApplyTemplWithSimpleIndentP"/>
	</xsl:template>
	<xsl:template match="subsection/paragraph/subparagraph/clause/subclause[@indent='up4']/item/subitem/quoted-block">
		<!--ul-->
	...
	<xsl:template match="subsection/paragraph/subparagraph/clause[@indent='up3']/subclause/item/subitem/quoted-block">
		<!--ul>
			<ul-->
		<p align="justify" class="indentItem">
			<xsl:apply-templates/>
	...
	<xsl:template match="subsection/paragraph/subparagraph[@indent='up2']/clause/subclause/item/subitem/quoted-block">
		<!--ul>
			<ul>
				<ul-->
		<p align="justify" class="indentSubItem">
	...
	<xsl:template match="subsection/paragraph/subparagraph[@indent='up2']/clause/subclause/item/subitem[@indent='up1']/quoted-block">
		<!--ul>
			<ul-->
		<p align="justify" class="indentSubItem">
			<xsl:apply-templates/>
	...
	<xsl:template match="subsection/paragraph[@indent='up1']/subparagraph/clause/subclause/item/subitem/quoted-block">
		<!--ul>
			<ul>
				<ul>
					<ul-->
	...
	<xsl:template match="subsection/paragraph[@indent='up1']/subparagraph/clause[@indent='up1']/subclause/item[@indent='up1']/subitem/quoted-block">
		<!--ul-->
		<p align="justify" class="indentItem">
			<xsl:apply-templates/>
		</p>
	...
	<xsl:template match="paragraph[@display-inline='yes-display-inline']/subparagraph[@indent='paragraph']">
		<!--ul-->
		<p align="justify" class="indentSubpar">
			<xsl:call-template name="ActualPrintText"/>
		</p>
	...
	<xsl:template match="paragraph[@indent='subsection']/subparagraph[@indent='subsection']/clause[@indent='clause']">
		<p align="justify" class="indent">
			<xsl:call-template name="ActualPrintText"/>
		</p>
	</xsl:template>
	...
	<xsl:template match="paragraph/subparagraph[@display-inline='yes-display-inline']/clause[@indent='subparagraph']">
		<!--ul-->
		<p align="justify" class="indentSubsection">
			<xsl:call-template name="ActualPrintText"/>
		</p>
	...
	<xsl:template match="paragraph[@indent='subsection']/subparagraph[@indent='subsection']/clause[@indent='paragraph']">
		<!--ul-->
		<p align="justify" class="indentSubsection">
			<xsl:call-template name="ActualPrintText"/>
		</p>
	...
	<xsl:template match="paragraph[@indent='subsection']/subparagraph[@indent='subsection']/clause[@indent='subsection' and @display-inline='no-display-inline']">
		<p align="justify" class="indent">
			<xsl:call-template name="ActualPrintText"/>
		</p>
	</xsl:template>
	<xsl:template match="paragraph[@indent='subsection']/subparagraph[@display-inline='yes-display-inline']/clause[@indent='subsection' and @display-inline='no-display-inline']">
		<p align="justify" class="indent">
			<xsl:call-template name="ActualPrintText"/>
		</p>
	</xsl:template>
	<xsl:template match="paragraph[@indent='subsection']/subparagraph[@indent='subsection']/clause[@indent='subsection' and @display-inline='yes-display-inline']">
		<xsl:apply-templates/>
	</xsl:template>
	<!--subclause-->
	...
	<xsl:template match="paragraph[@indent='subsection']/subparagraph[@indent='paragraph']/clause[@indent='paragraph']/subclause[@indent='subparagraph']">
		<!--ul-->
		<p align="justify" class="indentSubpar">
			<xsl:call-template name="ActualPrintText"/>
		</p>
	...
	<xsl:template match="paragraph[@indent='subsection']/subparagraph[@indent='subsection']/clause[@indent='paragraph']/subclause[@indent='subparagraph']">
		<!--ul-->
		<p align="justify" class="indentSubpar">
			<xsl:call-template name="ActualPrintText"/>
		</p>
	...
	<xsl:template match="paragraph[@indent='subsection']/subparagraph[@indent='subsection']/clause[@indent='subsection']/subclause[@indent='subsection' and @display-inline='no-display-inline']">
		<p align="justify" class="indent">
			<xsl:call-template name="ActualPrintText"/>
		</p>
	</xsl:template>
	<xsl:template match="paragraph[@indent='subsection']/subparagraph[@display-inline='no-display-inline']/clause[@display-inline='no-display-inline']/subclause[@indent='subsection' and @display-inline='no-display-inline']">
		<p align="justify" class="indent">
			<xsl:call-template name="ActualPrintText"/>
		</p>
	</xsl:template>
	<xsl:template match="paragraph[@indent='subsection']/subparagraph[@indent='subsection']/clause[@indent='subsection']/subclause[@indent='subsection' and @display-inline='yes-display-inline']">
		<xsl:apply-templates/>
	</xsl:template>
	<xsl:template match="paragraph/subparagraph/clause[@indent='subparagraph']/subclause[@indent='clause']">
		<!--ul-->
		<p align="justify" class="indentClause">
			<xsl:call-template name="ActualPrintText"/>
		</p>
	...
	<xsl:template match="paragraph/subparagraph/clause/subclause[@indent='clause']/item[@indent='subclause']">
		<!--ul-->
		<p align="justify" class="indentSubclause">
			<xsl:call-template name="ActualPrintText"/>
		</p>
	...
	<xsl:template match="paragraph/subparagraph/clause[@indent='subparagraph']/subclause[@indent='clause']/item[@indent='clause']">
		<p align="justify" class="indent">
			<xsl:call-template name="ActualPrintText"/>
		</p>
	</xsl:template>
	...
	<xsl:template match="paragraph/subparagraph/clause[@display-inline='yes-display-inline']/subclause[@display-inline='yes-display-inline']/item[@indent='clause']">
		<!--ul-->
		<p align="justify" class="indentClause">
			<xsl:call-template name="ActualPrintText"/>
		</p>
	...
	<xsl:template match="paragraph/subparagraph[@display-inline='yes-display-inline']/clause[@indent='subparagraph']/subclause[@display-inline='yes-display-inline']/item[@indent='clause']">
		<!--ul-->
		<p align="justify" class="indentClause">
			<xsl:call-template name="ActualPrintText"/>
		</p>
	...
	<xsl:template match="paragraph/subparagraph/clause/subclause[@indent='subparagraph']/item[@indent='clause']">
		<ul>
			<p align="justify" class="indent">
				<xsl:call-template name="ActualPrintText"/>
			</p>
	...
	<xsl:template match="paragraph/subparagraph/clause[@indent='subparagraph']/subclause[@indent='subparagraph']/item[@indent='subparagraph']">
		<p align="justify" class="indent">
			<xsl:call-template name="ActualPrintText"/>
		</p>
	</xsl:template>
	...
	<xsl:template match="paragraph[@indent='subsection']/subparagraph[@indent='paragraph']/clause[@indent='paragraph']/subclause[@indent='paragraph']/item[@indent='subparagraph']">
		<!--ul-->
		<p align="justify" class="indentSubpar">
			<xsl:call-template name="ActualPrintText"/>
		</p>
	...
	<xsl:template match="paragraph[@indent='subsection']/subparagraph[@indent='subsection']/clause[@indent='subsection']/subclause[@indent='subsection']/item[@indent='subsection' and @display-inline='no-display-inline']">
		<p align="justify" class="indent">
			<xsl:call-template name="ActualPrintText"/>
		</p>
	</xsl:template>
	<xsl:template match="paragraph[@indent='subsection']/subparagraph[@indent='subsection']/clause[@indent='subsection']/subclause[@indent='subsection']/item[@indent='subsection' and @display-inline='yes-display-inline']">
		<xsl:apply-templates/>
	</xsl:template>
	<!--subitem-->
	...
	<xsl:template match="paragraph/subparagraph/clause/subclause/item/subitem[@indent='subparagraph']">
		<p align="justify" class="indent">
			<xsl:call-template name="ActualPrintText"/>
		</p>
	</xsl:template>
	<xsl:template match="paragraph[@indent='subsection']/subparagraph[@indent='paragraph']/clause[@indent='paragraph']/subclause[@indent='paragraph']/item[@indent='subparagraph']/subitem[@indent='subparagraph']">
		<p align="justify" class="indent">
			<xsl:call-template name="ActualPrintText"/>
		</p>
	</xsl:template>
	<xsl:template match="paragraph[@indent='subsection']/subparagraph[@indent='paragraph']/clause[@indent='subparagraph']/subclause[@display-inline='yes-display-inline']/item[@indent='subparagraph']/subitem[@indent='subparagraph']">
		<p align="justify" class="indent">
			<xsl:call-template name="ActualPrintText"/>
		</p>
	</xsl:template>
	<xsl:template match="paragraph[@indent='subsection']/subparagraph[@indent='subsection']/clause[@indent='subsection']/subclause[@indent='subsection']/item[@indent='subsection']/subitem[@indent='subsection' and @display-inline='no-display-inline']">
		<p align="justify" class="indent">
			<xsl:call-template name="ActualPrintText"/>
		</p>
	</xsl:template>
	<xsl:template match="paragraph[@indent='subsection']/subparagraph[@indent='subsection']/clause[@indent='subsection']/subclause[@indent='subsection']/item[@indent='subsection']/subitem[@indent='subsection' and @display-inline='yes-display-inline']">
		<xsl:apply-templates/>
	</xsl:template>
	...
	<xsl:template match="deleted-phrase">
		...
		<xsl:choose>
			...
			<xsl:when test="(ancestor::appropriations-major or ancestor::appropriations-intermediate or ancestor::appropriations-small) and parent::header">

				<!--xsl:call-template name="displayHeader"/-->
				<xsl:call-template name="PrintHeaderForAppropriations"/>	
			</xsl:when>
			<xsl:when test="(ancestor::appropriations-major or ancestor::appropriations-intermediate or ancestor::appropriations-small) and parent::subheader">
			...
			<xsl:when test="(parent::enum and ./@deleted-display-style='bold-brackets') or    (parent::enum and ./@reported-display-style='bold-brackets')">
			...
			<xsl:when test="(./@reported-display-style='parentheses-boldface-italic') or    (./@reported-display-style='brackets-boldface-italic')">
				<xsl:apply-templates/>
			</xsl:when>
	...
	<xsl:template match="attestation-group">
		<xsl:choose>
			<xsl:when test="$billStage='Received-in-Senate' or $billStage='Received-in-House'     or $billStage='Referred-in-Senate' or $billStage='Referred-in-House'  or     $resolutionStage='Referred-in-Senate' or $resolutionStage='Received-in-Senate' or  $resolutionStage='Placed-on-Calendar-Senate'">
							...
							<td align="right">
								<span class="simplecap">
									...
									<xsl:call-template name="displayAttestor">
										<xsl:with-param name="displayFlag" select="attestor/@display"/>
									</xsl:call-template>
								</span>
								<xsl:text disable-output-escaping="yes"> </xsl:text>
								<xsl:text disable-output-escaping="yes"> </xsl:text>
	...
	<xsl:template match="role">
		<xsl:choose>
			<xsl:when test="$resolutionStage='Enrolled-in-Senate' or $documentStage='Enrolled-Bill' or $resolutionStage='Enrolled-House' or   $resolutionStage='Re-enrolled-in-Senate' or  $billStage='Re-Enrolled-Bill'">
				<xsl:if test="$resolutionStage='Enrolled-in-Senate' and not(contains($resolutionType, 'joint'))">
					<p class="indent"> Attest: </p>
				</xsl:if>
				<xsl:if test=" (not(./attestor ) or ./attestor[@display='no' ]) and not (parent::attestation-group/attestor) and not(contains($resolutionType, 'joint')) ">
					<p class="indent"> Attest: </p>
				</xsl:if>
				<P align="right">
						...
						<tr>
							<td align="right">
								<i>
									...
									<br/>
									<xsl:choose>
										<xsl:when test=".='Vice President of the United States and President of the Senate.'">
			...
			<xsl:otherwise>
				...
				<xsl:if test="not (local-name(preceding-sibling::*[1])='attestor') and not (local-name(preceding-sibling::*[1])='proxy')">
	...
	<xsl:template name="PrintImageByName">
		...
		<xsl:choose>
			<xsl:when test="$imageName='EnrolledTitle_106.JPG'">
				<center><img src="EnrolledTitle_106.JPG" alt=""/></center>
			</xsl:when>
			<xsl:when test="$imageName='EnrolledTitle_107.JPG'">
				<center><img src="EnrolledTitle_107.JPG" alt=""/></center>
			</xsl:when>
			<xsl:when test="$imageName='EnrolledTitle_108.JPG'">
				<center><img src="EnrolledTitle_108.JPG" alt=""/></center>
			</xsl:when>
			<xsl:when test="$imageName='EnrolledTitle_109.JPG'">
				<center><img src="EnrolledTitle_109.JPG" alt=""/></center>
			</xsl:when>
			<xsl:when test="$imageName='EnrolledTitle_110.JPG'">
				<center><img src="EnrolledTitle_110.JPG" alt=""/></center>
			</xsl:when>
			<xsl:when test="$imageName='EnrolledTitle_111.JPG'">
				<center><img src="EnrolledTitle_111.JPG" alt=""/></center>
			</xsl:when>
			<xsl:when test="$imageName='EnrolledTitle_112.JPG'">
				<center><img src="EnrolledTitle_112.JPG" alt=""/></center>
			</xsl:when>
			<xsl:when test="$imageName='EnrolledTitle_113.JPG'">
				<center><img src="EnrolledTitle_113.JPG" alt=""/></center>
			</xsl:when>
			<xsl:when test="$imageName='EnrolledTitle_114.JPG'">
				<center><img src="EnrolledTitle_114.JPG" alt=""/></center>
			</xsl:when>
			<xsl:when test="$imageName='EnrolledTitle_115.JPG'">
				<center><img src="EnrolledTitle_115.JPG" alt=""/></center>
			</xsl:when>			
		</xsl:choose>
	</xsl:template>
	...
	<xsl:template name="displaySection">
		...
		<xsl:choose>
			...
			<xsl:when test="contains($currentElementStyle, 'archaic') and ancestor::quoted-block and $isIdReferenceExists='yes'">
				<center>
					<a>
						<xsl:attribute name="href">
							<xsl:text>#</xsl:text>
			...
			<xsl:when test="$currentElementStyle='archaic' or $currentElementStyle='archaic-paragraph' ">
				<center>
			...
			<xsl:when test="$currentElementStyle='USC' and $isIdReferenceExists='no'">
				...
				<xsl:choose>
					...
					<xsl:when test="child::header and header/following-sibling::text/@display-inline='yes-display-inline'">
						<xsl:apply-templates select="header/following-sibling::text[@display-inline='yes-display-inline']/following-sibling::*"/>
					</xsl:when>
					<xsl:when test="child::enum and enum/following-sibling::text/@display-inline='yes-display-inline'">
						<xsl:apply-templates select="enum/following-sibling::text[@display-inline='yes-display-inline']/following-sibling::*"/>
					</xsl:when>
					<xsl:when test="child::header">
						<xsl:apply-templates select="child::header/following-sibling::*"/>
					</xsl:when>
			...
			<xsl:when test="(//bill or //resolution) and  ($currentElementStyle='traditional' or $currentElementStyle='appropriations') and $isIdReferenceExists='yes'">
				<a>
					<xsl:attribute name="href">
						<xsl:text>#</xsl:text>
						<xsl:value-of select="@id"/>
					...
					<center>
						...
						<xsl:if test="ancestor::quoted-block and not(header/enum-in-header or parent::section and ancestor::quoted-block[1]/@style='traditional')">
							<xsl:call-template name="openQuotes"/>
						</xsl:if>
						<xsl:apply-templates select="header"/>
					</center>
			...
			<xsl:when test="((ancestor::resolution-body/@style='traditional'  and not (ancestor::quoted-block[1]/@style != 'traditional'))or $currentElementStyle='traditional'       or ($currentElementStyle='appropriations' and not(@section-type='undesignated-section')       and not (contains(local-name(child::*), 'appropriations')))         and not(/resolution/descendant::*/@idref=./@id))">
				<xsl:variable name="appropReportedStyle">
					<xsl:call-template name="getAppropriationReportingStyle"/>
				</xsl:variable>
			...
			<xsl:when test="($billType='olc'  or $currentElementStyle='OLC' ) and $isIdReferenceExists='yes'">				
				<p align="justify" class="hang">
					<a>
						<xsl:attribute name="href">
							<xsl:text>#</xsl:text>
					...
					<xsl:if test="text[@display-inline='yes-display-inline'] or (text and not (text/@display-inline))">
						<xsl:text> </xsl:text>
						<xsl:apply-templates select="text"/>
						<xsl:if test="quoted-block[@display-inline='yes-display-inline']">
							<xsl:apply-templates select="quoted-block"/>
				...
				<xsl:if test="quoted-block[@display-inline='no-display-inline'] or (quoted-block and not(quoted-block/@display-inline))">
					<xsl:apply-templates select="quoted-block"/>
				</xsl:if>
				<xsl:choose>
			...
			<xsl:when test="$currentElementStyle='tax' or $currentElementStyle='defense' or $currentElementStyle='USC' and $isIdReferenceExists='yes'">
				<!--xsl:apply-templates/-->
				<a>
					<xsl:attribute name="href">
						<xsl:text>#</xsl:text>
			...
			<xsl:when test="$currentElementStyle='tax' or $currentElementStyle='defense' and $isIdReferenceExists='no'">
				<!--xsl:apply-templates/-->
				<p align="justify" class="hang" style="margin-left: 2em">
					<b>
						<xsl:apply-templates select="enum"/>
			...
			<xsl:when test="$currentElementStyle = 'OLC' and $isIdReferenceExists='no'">
				...
				<p align="justify" class="hang">
					...
					<!--TB 28Dec2007 Bug #767 -->
					<xsl:if test="$currentElementStyle='traditional-inline' and  text/@display-inline='yes-display-inline'">
						<span class="sectionlevelOLCnuclear">
							<xsl:text>—</xsl:text>
							<xsl:apply-templates select="text"/>
							<xsl:if test="quoted-block[@display-inline='yes-display-inline']">
				...
				<!--/ul-->
				<xsl:if test="not($currentElementStyle='traditional-inline'  and  text/@display-inline='yes-display-inline')">
					<p align="left" class="indent">
						<xsl:apply-templates select="text"/>
						<xsl:if test="quoted-block[@display-inline='yes-display-inline']">
							<xsl:apply-templates select="quoted-block"/>
	...
	<xsl:template name="openQuotes">
		<xsl:text>“</xsl:text>
		<xsl:if test="ancestor::quoted-block and ancestor::quoted-block/descendant::quoted-block = ancestor::quoted-block">
			<span class="thinspace">
				<xsl:text> </xsl:text>
			</span>
			<xsl:text>‘</xsl:text>
	...
	<xsl:template name="closeQuotesByCondition">
		...
		<xsl:if test="(ancestor::quoted-block[1]/child::*[last()]/preceding-sibling::*[1] =  ancestor-or-self::*  and  name(ancestor::quoted-block/child::*[last()])='after-quoted-block' )">
			<xsl:variable name="toCloseQuotes">
				<xsl:call-template name="isQuoteMustClose"/>
			</xsl:variable>
			<xsl:choose>
	...
	<xsl:template name="isQuoteMustClose">
		<xsl:choose>
			<xsl:when test="following-sibling::*  and  (name(self::*) = name(following-sibling::* )     or (name(following-sibling::*[last()]) !='header'  and name(following-sibling::*[last()]) != 'text' ) ) ">
				<xsl:text>false</xsl:text>
			</xsl:when>
			<xsl:when test="parent::*/following-sibling::* and local-name(parent::*/following-sibling::* ) != 'after-quoted-block' ">
				<xsl:text>false</xsl:text>
			</xsl:when>
			<xsl:when test="ancestor::*[2]/following-sibling::*  and  ancestor::quoted-block[1]/descendant::* = ancestor::*[2] and name(ancestor::*[2]/following-sibling::*[1])!='after-quoted-block'  ">
				<xsl:text>false</xsl:text>
			</xsl:when>
			<xsl:when test="ancestor::*[3]/following-sibling::*  and  ancestor::quoted-block[1]/descendant::* = ancestor::*[3]  and  name(ancestor::*[3]/following-sibling::*[1])!='after-quoted-block'  ">
				<xsl:text>false</xsl:text>
			</xsl:when>
			<xsl:when test="ancestor::*[4]/following-sibling::*  and  ancestor::quoted-block[1]/descendant::* = ancestor::*[4]  and name(ancestor::*[4]/following-sibling::*[1])!='after-quoted-block'  ">
				<xsl:text>false</xsl:text>
			</xsl:when>
			<xsl:when test="ancestor::*[5]/following-sibling::*  and  ancestor::quoted-block[1]/descendant::* = ancestor::*[5]  and  name(ancestor::*[5]/following-sibling::*[1])!='after-quoted-block'  ">
				<xsl:text>false</xsl:text>
			</xsl:when>
			<xsl:when test="ancestor::*[6]/following-sibling::*  and  ancestor::quoted-block[1]/descendant::* = ancestor::*[6] and  name(ancestor::*[6]/following-sibling::*[1])!='after-quoted-block'   ">
				<xsl:text>false</xsl:text>
			</xsl:when>
			<xsl:when test="ancestor::*[7]/following-sibling::*  and  ancestor::quoted-block[1]/descendant::* = ancestor::*[7] and  name(ancestor::*[7]/following-sibling::*[1])!='after-quoted-block'  ">
				<xsl:text>false</xsl:text>
			</xsl:when>
			<xsl:when test="ancestor::*[8]/following-sibling::*  and  ancestor::quoted-block[1]/descendant::* = ancestor::*[8]  and  name(ancestor::*[8]/following-sibling::*[1])!='after-quoted-block'  ">
				<xsl:text>false</xsl:text>
			</xsl:when>
			<xsl:when test="ancestor::*[9]/following-sibling::*  and  ancestor::quoted-block[1]/descendant::* = ancestor::*[9]  and name(ancestor::*[9]/following-sibling::*[1])!='after-quoted-block'  ">
				<xsl:text>false</xsl:text>
			</xsl:when>
			<xsl:when test="ancestor::*[10]/following-sibling::*  and  ancestor::quoted-block[1]/descendant::* = ancestor::*[10] and  name(ancestor::*[10]/following-sibling::*[1])!='after-quoted-block'   ">
				<xsl:text>false</xsl:text>
			</xsl:when>
			<xsl:otherwise>
				<xsl:text>true</xsl:text>
	...
	<xsl:template name="displayTitleByStyle">
		...
		<xsl:choose>
			...
			<xsl:when test="parent::paragraph or parent::subparagraph or parent::clause or parent::subclause or parent::item or parent::subitem">
	...
	<xsl:template name="actualDisplayTitle">
		...
		<xsl:choose>
			...
			<!-- TB  -->
			<xsl:when test="parent::header and not (child::*) and ((following-sibling::deleted-phrase or preceding-sibling::deleted-phrase) or (following-sibling::added-phrase or preceding-sibling::added-phrase))">
				<xsl:value-of select="."/>
			</xsl:when>
	...
	<xsl:template name="displayTocVerticalSpace">
		<xsl:if test="not(@level='section'  or @level='subsection'  or @level='paragraph'   or @level='subparagraph'  or @level='clause'  or @level='subclause' or @level='item'  or @level='subitem' )">
			<p/>			
		</xsl:if>
	</xsl:template>
	...
	<xsl:template name="getCurrentElementStyle">
		<xsl:choose>
			...
			<xsl:when test="ancestor::quoted-block[1]/descendant::subtitle/@style ">
				<xsl:choose>
					<xsl:when test="ancestor-or-self::subtitle/text() = ancestor::quoted-block[1]/descendant::subtitle/text()">
						<xsl:choose>
			...
			<xsl:when test="ancestor::quoted-block[1]/descendant::title/@style ">
				<xsl:choose>
					<xsl:when test="ancestor-or-self::title/text() = ancestor::quoted-block[1]/descendant::title/text()">
						<xsl:choose>
			...
			<xsl:when test="ancestor-or-self::resolution-body[1]/@style">
				<xsl:choose>
					...
					<!-- TB 30Dec2008 -->
					<xsl:when test="ancestor-or-self::resolution-body[1]/@style ='order-of-business'">
			...
			<xsl:when test="$documentType !=''">
				<xsl:choose>
					...
					<xsl:when test="$documentType='appropriations'">
						<xsl:choose>
							<xsl:when test="local-name() = 'section' or parent::section or local-name(../..) = 'section'">
								<xsl:text>traditional</xsl:text>
							</xsl:when>
							<xsl:otherwise>
	...
	<xsl:template name="displayHeaderInStyle">
		...
		<xsl:choose>
			<!-- OLC Style -->
			<xsl:when test="(parent::division or parent::subdivision) and $currentElementStyle='OLC' ">
			...
			<xsl:when test="(parent::subdivision or parent::division) and ($currentElementStyle='USC' )">
				<span class="titlelevelIRCEx">
					<xsl:apply-templates/>
				</span>
			</xsl:when>	
			<!-- Traditional Style -->
			<xsl:when test="parent::division and ($currentElementStyle='traditional-inline' or $currentElementStyle='appropriations' )">
				<span class="titlelevelTradIn">
					<xsl:apply-templates/>
				</span>
			</xsl:when>
			<xsl:when test="parent::subdivision and ($currentElementStyle='traditional'   or contains($currentElementStyle,'archaic' ))">
				<span class="initialcapArchaic">
					<xsl:apply-templates/>
				</span>
			</xsl:when>	
			<xsl:when test="parent::subdivision and ($currentElementStyle='traditional-inline' or $currentElementStyle='appropriations' )">
				<span class="subchapterlevelOLC">
					<xsl:apply-templates/>
				</span>
			</xsl:when>	
			<xsl:when test="(parent::division or parent::title or parent::subdivision) and ($currentElementStyle='traditional'  or $currentElementStyle='traditional-inline'   or   contains($currentElementStyle,'archaic')) ">
				<span class="subtitlelevelTrad" style="text-transform:uppercase">
					<xsl:apply-templates/>
				</span>
			</xsl:when>
			<xsl:when test="parent::subtitle and ($currentElementStyle='traditional'  or $currentElementStyle='traditional-inline'   or   $currentElementStyle='archaic-paragraph') ">
				<span class="subtitlelevelTrad">
					<xsl:apply-templates/>
				</span>
			</xsl:when>
			<xsl:when test="parent::part and ($currentElementStyle='traditional'  or $currentElementStyle='traditional-inline'   or   $currentElementStyle='archaic-paragraph') ">
				<span class="partlevelTrad">
					<xsl:apply-templates/>
				</span>
			</xsl:when>
			<xsl:when test="parent::subpart and ($currentElementStyle='traditional'  or $currentElementStyle='traditional-inline'   or   $currentElementStyle='archaic-paragraph')">
				<span class="subpartlevelTrad">
					<xsl:apply-templates/>
				</span>
			</xsl:when>
			...
			<xsl:when test="parent::chapter and ( $currentElementStyle='traditional-inline'  or $currentElementStyle='appropriations')">
				<span class="titlelevelTradEx">
					<xsl:apply-templates/>
				</span>
			</xsl:when>
			<xsl:when test="parent::subchapter and ($currentElementStyle='traditional'   or   $currentElementStyle='archaic-paragraph') ">
				<span class="subtitlelevelTrad" style="text-transform:uppercase">
					<xsl:apply-templates/>
				</span>
			</xsl:when>
			<xsl:when test="parent::subchapter and ($currentElementStyle='traditional-inline'  or   $currentElementStyle='appropriations') ">
				<span class="subtitlelevelTrad">
					<xsl:apply-templates/>
				</span>
			</xsl:when>
			<!-- Tax Style and Nuclear only chapter is different between them -->			
			<xsl:when test="(parent::division or parent::title or parent::subdivision) and ($currentElementStyle='tax'  or  $currentElementStyle='nuclear' )">
				<span class="titlelevelIRC" style="text-transform:uppercase">
					<xsl:apply-templates/>
				</span>
			</xsl:when>
			<xsl:when test="parent::subtitle and  ($currentElementStyle='tax'  or  $currentElementStyle='nuclear' ) ">
				<span class="subtitlelevelIRC">
					<xsl:apply-templates/>
				</span>
			</xsl:when>
			<xsl:when test="parent::part and  ($currentElementStyle='tax'  or  $currentElementStyle='nuclear' )">
				<span class="partlevelIRC" style="text-transform:uppercase">
					<xsl:apply-templates/>
				</span>
			</xsl:when>
			<xsl:when test="parent::subpart and  ($currentElementStyle='tax'  or  $currentElementStyle='nuclear' )">
				<span class="subpartlevelIRC">
					<xsl:apply-templates/>
				</span>
			</xsl:when>
			...
			<xsl:when test="parent::subchapter and  ($currentElementStyle='tax'  or  $currentElementStyle='nuclear' )">
				<span class="subchapterlevelIRC">
					<xsl:apply-templates/>
				</span>
			</xsl:when>
	...
	<xsl:template name="actualPrintHorizontalStars">
		...
		<xsl:if test="not($stringAfter = '.' or $stringAfter=',' or $stringAfter=';' or  $stringAfter=':' or $stringAfter='?' or $stringAfter='!' or $stringAfter='...' or $stringAfter='/')">
			<span class="nSpace">
				<xsl:text> </xsl:text>
			</span>
		</xsl:if>
	...
	<xsl:template name="printCongressAndSessionForSenateAmend">
		<span class="bold" style="FONT-SIZE:15px">
			<xsl:choose>
				<xsl:when test="//amendment-form/congress/@display='no' and //amendment-form/session/@display='no'">
					<!-- nothing -->
				</xsl:when>
				<xsl:otherwise>
	...
	<xsl:template name="GetNumberToPrint">
		...
		<xsl:if test="//engrossed-amendment-body">
			<xsl:variable name="textToSearch">
				<xsl:value-of select="//engrossed-amendment-body/section[@section-type='resolved']/text"/>
			</xsl:variable>
	...
	<xsl:template name="IsSenateAmendment">
		<xsl:choose>
			...
			<xsl:when test="contains(translate(//amendment-form/current-chamber, $upper, $lower), 'senate') ">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<xsl:when test="contains(translate(//engrossed-amendment-form/current-chamber, $upper, $lower), 'senate') ">
				<xsl:text>yes</xsl:text>
			</xsl:when>
	...
	<xsl:template name="printQuotedText">
		...
		<xsl:if test="local-name()='paragraph' and $currElementStyle='archaic-paragraph'  and  self::*/header/text() != ''">
	...
	<xsl:template name="actualPrintFirstColumnMultiToc">
		...
		<xsl:variable name="tocLength" select="(string-length(toc-enum)+string-length(level-header)+string-length(target)) - 10 "/>
		<xsl:variable name="tocLengthForCalc">
			<xsl:call-template name="calcLengthForLeader">
			...
			<xsl:when test="$isBold='yes' and $isItalic='yes'">
				<b><i>
					<xsl:call-template name="printMultiColTocMainContent">
						<xsl:with-param name="tocLengthForCalc" select="$tocLengthForCalc"/>
					</xsl:call-template>	
				</i></b>
			</xsl:when>
	...
	<xsl:template name="printMultiColTocMainContent">
		<xsl:param name="tocLengthForCalc"/>
		<xsl:if test="ancestor::quoted-block">
			<xsl:call-template name="openQuotes"/>
		</xsl:if>
		<xsl:apply-templates select="toc-enum"/>
	...
	<xsl:template name="IsPrintItalicTextForReport">
		<xsl:choose>
			<xsl:when test="ancestor-or-self::amendment-block and ($isReport='yes' and $confReportStyle='committee' and not (parent::amendment-instruction)) ">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<xsl:otherwise>
				<xsl:text>no</xsl:text>
		...
		<xsl:call-template name="printSessionAndCongressForBills"/>
			<xsl:if test="not(//legis-num/@display='no')">
				...
				<xsl:choose>
					...
					<xsl:when test="string-length(legis-num) &lt; 16 and string-length($tempLegisNum) &gt; 13">
						<TABLE width="12%" height="50" border="0" align="right">
							<TR>
								<TD/>
							</TR>
					...
					<xsl:when test="string-length(legis-num) &lt; 14 and string-length($tempLegisNum) &gt; 10">
						<TABLE width="25%" height="50" border="0" align="right">
							<TR>
								<TD/>
							</TR>
	...
	<xsl:template match="committee-report-subpara">
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				<table width="90%" border="0" align="center" style="font-size: 14pt;">
					<tr>
						<td class="indent">
							<p align="justify">
								<xsl:apply-templates/>
	...
	<xsl:template name="prinVoiceVoteTitle">
		<xsl:variable name="isVoceVote">
			<xsl:choose>
				<xsl:when test="contains(vote-result, 'voice vote') or contains(vote-result, 'withdrawn')">
					<xsl:text>Y</xsl:text>
				</xsl:when>
				<xsl:otherwise>
					<xsl:text>N</xsl:text>
		...
		<xsl:if test="$isVoceVote='Y'">
			<div align="center" class="simplecap">voice vote</div>
			<br/>
		</xsl:if>
	</xsl:template>
	...
	<xsl:template match="committee-vote-num">
		...
		<div class="simplecap" align="center">
				<xsl:value-of select="translate(., $upper,$lower)"/>
			</div>
			<!--/xsl:otherwise>
		</xsl:choose-->
		...
		<!--xsl:choose>
			...
			<div class="indent" align="justify">				
				...
				<xsl:variable name="textToPrintWithSpaces">
					<xsl:value-of select="concat(concat(substring-before($textToPrintNoSpace, $sponsorName), $sponsorNameWithSpace), substring-after($textToPrintNoSpace, $sponsorName))"/>
				</xsl:variable>
				<xsl:value-of select="$textToPrintWithSpaces"/>
				
				<xsl:variable name="isVoceVote">
					<xsl:choose>
						<xsl:when test="contains(parent::*/vote-result, 'voice vote') or contains(parent::*/vote-result, 'withdrawn')">
							<xsl:text>Y</xsl:text>
						</xsl:when>
						<xsl:otherwise>
							<xsl:text>N</xsl:text>
	...
	<xsl:template match="legis-num" mode="committee-report">
		...
		<!--xsl:choose>
			...
			<xsl:otherwise-->
				<!-- Nothing-->
		<div style="font-variant: small-caps;" align="center">				
			<xsl:value-of select="."/>								
		</div>
			<!--/xsl:otherwise>
		</xsl:choose-->
	...
	<xsl:template match="vote-result">
		...
		<xsl:variable name="isVoceVote">
			<xsl:choose>
				<xsl:when test="contains(., 'voice vote') or contains(., 'withdrawn')">
					<xsl:text>Y</xsl:text>
				</xsl:when>
				<xsl:otherwise>
					<xsl:text>N</xsl:text>
	...
	<xsl:template name="insertTotalsLine">
		...
		<xsl:variable name="emptyColumnWidth">
			<xsl:choose>
				<xsl:when test="$isPrintPresent ='yes' and $isPrintNotVoting = 'yes'">
					<xsl:value-of select="concat(number (substring-before($memberColWidth, '%')) + 12, '%')"/>
				</xsl:when>
				<xsl:when test="$isPrintPresent ='yes' or $isPrintNotVoting = 'yes'">
					<xsl:value-of select="concat(number (substring-before($memberColWidth, '%')) + 6, '%')"/>
				</xsl:when>
				<xsl:otherwise>
					<xsl:value-of select="$memberColWidth"/>
				</xsl:otherwise>
		...
		<!--the actual totals-->
			...
			<tr>
				...
				<td align="left">
					...
					<b><xsl:text>Vote Total:</xsl:text></b>
				</td>
				<td width="6%" align="center">
					<b><xsl:value-of select="ancestor::committee-vote/totals-by-vote/yea-total"/></b>
				</td>
				<td width="6%" align="center">
					<b><xsl:value-of select="ancestor::committee-vote/totals-by-vote/nay-total"/></b>
				</td>
				<xsl:if test="$isPrintPresent='yes'">
					<td width="6%" align="center">					
						<b><xsl:value-of select="ancestor::committee-vote/totals-by-vote/present-total"/></b>
					</td>
				</xsl:if>
				<xsl:if test="$isPrintNotVoting='yes'">
					<td width="6%" align="center">
						<b><xsl:value-of select="ancestor::committee-vote/totals-by-vote/not-voting-total"/></b>
					</td>
				</xsl:if>
			</tr>
		</xsl:if>
				...
				<xsl:if test="vote != ''">
					<xsl:call-template name="loop">
						<xsl:with-param name="index">
							<xsl:value-of select="70 - string-length(legislator) - string-length(legislator/@role)"/>
						</xsl:with-param>								
					</xsl:call-template>
				</xsl:if>
			</td>
	...
	<xsl:template name="printActionDateForBills">		
		<xsl:if test="(translate($documentStage,$upper,$lower)='engrossed-in-senate' or translate($documentStage,$upper,$lower)='engrossed-amendment-senate') and (//bill/@public-print='yes' or //resolution/@public-print='yes') ">			
			<xsl:for-each select="//form/action">
				<xsl:choose>
					<xsl:when test="(position() = last() and count(//form/action) &gt; 1)  or (count(//form/action)  = 1) or not(@display='yes')">
					...
					<xsl:otherwise>
						<center>
							<p/>
							<span class="simplecap">
								<xsl:value-of select="substring-before(.,substring-before(substring-after(action-date,'(') ,')')) "/>
							</span>
							<xsl:value-of select="substring-before(substring-after(action-date,'(') ,',') "/>
							<span class="simplecap">
								<xsl:text>, </xsl:text>
								<xsl:value-of select="substring-before(substring-after(action-date,',') ,')') "/>
								<xsl:value-of select="substring-after(action-date,substring-before(substring-after(action-date,'(') ,')')) "/>
							</span>
							<p/>
	...
	<xsl:template name="defineIndentationRulesParagraph">
		<xsl:variable name="displayInlineCount">
			<xsl:choose>
				<xsl:when test="ancestor::rules-clause/@display-inline='yes-display-inline' or preceding-sibling::rules-paragraph/@indent='up1' or preceding-sibling::rules-paragraph/@display-inline='yes-display-inline' ">
					<xsl:text>1</xsl:text>
				</xsl:when>
				<xsl:otherwise>
					<xsl:text>0</xsl:text>
	...
	<xsl:template name="displayInlineRulesCount2">
		...
		<xsl:choose>
			<xsl:when test="((ancestor::*[1]/@display-inline='yes-display-inline'  and not(local-name(ancestor::*[1]) = 'quoted-block')) or     ancestor::*[1]/preceding-sibling::rules-paragraph/@display-inline='yes-display-inline' or      ancestor::*[1]/preceding-sibling::rules-subparagraph/@display-inline='yes-display-inline' or      ancestor::*[1]/preceding-sibling::rules-subdivision/@display-inline='yes-display-inline' or      ancestor::*[1]/preceding-sibling::rules-item/@display-inline='yes-display-inline' or      ancestor::*[1]/preceding-sibling::rules-subitem/@display-inline='yes-display-inline' )     and (ancestor::*[2]/@display-inline='yes-display-inline' or     ancestor::*[2]/preceding-sibling::rules-paragraph/@display-inline='yes-display-inline' or      ancestor::*[2]/preceding-sibling::rules-subparagraph/@display-inline='yes-display-inline' or      ancestor::*[2]/preceding-sibling::rules-subdivision/@display-inline='yes-display-inline' or      ancestor::*[2]/preceding-sibling::rules-item/@display-inline='yes-display-inline' or      ancestor::*[2]/preceding-sibling::rules-subitem/@display-inline='yes-display-inline' ) ">
				<xsl:text>2</xsl:text>
			</xsl:when>
			<xsl:when test="((ancestor::*[1]/@display-inline='yes-display-inline'  and not(local-name(ancestor::*[1]) = 'quoted-block'))  or     ancestor::*[1]/preceding-sibling::rules-paragraph/@display-inline='yes-display-inline' or      ancestor::*[1]/preceding-sibling::rules-subparagraph/@display-inline='yes-display-inline' or      ancestor::*[1]/preceding-sibling::rules-subdivision/@display-inline='yes-display-inline' or      ancestor::*[1]/preceding-sibling::rules-item/@display-inline='yes-display-inline' or      ancestor::*[1]/preceding-sibling::rules-subitem/@display-inline='yes-display-inline' ) ">
				<xsl:value-of select="1+number($anc2_up_level)"/>
			</xsl:when>
			<xsl:when test="((ancestor::*[2]/@display-inline='yes-display-inline'   and not(local-name(ancestor::*[2]) = 'quoted-block')) or     ancestor::*[2]/preceding-sibling::rules-paragraph//@display-inline='yes-display-inline' or      ancestor::*[2]/preceding-sibling::rules-subparagraph//@display-inline='yes-display-inline' or      ancestor::*[2]/preceding-sibling::rules-subdivision//@display-inline='yes-display-inline' or      ancestor::*[2]/preceding-sibling::rules-item//@display-inline='yes-display-inline' or      ancestor::*[2]/preceding-sibling::rules-subitem//@display-inline='yes-display-inline' )">
				<xsl:value-of select="1+number($anc1_up_level)"/>
			</xsl:when>
			<xsl:otherwise>
				<xsl:value-of select="number($anc1_up_level)+number($anc2_up_level)"/>
	...
	<xsl:template name="displayInlineRulesCount3">
		...
		<xsl:choose>
			<xsl:when test="(ancestor::*[3]/@display-inline='yes-display-inline'  and not(local-name(ancestor::*[3]) = 'quoted-block')) or      ancestor::*[3]/preceding-sibling::rules-paragraph/@display-inline='yes-display-inline' or      ancestor::*[3]/preceding-sibling::rules-subparagraph/@display-inline='yes-display-inline' or      ancestor::*[3]/preceding-sibling::rules-subdivision/@display-inline='yes-display-inline' or      ancestor::*[3]/preceding-sibling::rules-item/@display-inline='yes-display-inline' or      ancestor::*[3]/preceding-sibling::rules-subitem/@display-inline='yes-display-inline' ">
				<xsl:value-of select="1 + number($countMax2)"/>
			</xsl:when>
			<xsl:otherwise>
				<xsl:value-of select="number($anc3_up_level) + number($countMax2)"/>
	...
	<xsl:template name="displayInlineRulesCount4">
		...
		<xsl:choose>
			<xsl:when test="ancestor::*[4]/@display-inline='yes-display-inline' or     ancestor::*[4]/preceding-sibling::rules-paragraph/@display-inline='yes-display-inline' or      ancestor::*[4]/preceding-sibling::rules-subparagraph/@display-inline='yes-display-inline' or      ancestor::*[4]/preceding-sibling::rules-subdivision/@display-inline='yes-display-inline' or      ancestor::*[4]/preceding-sibling::rules-item/@display-inline='yes-display-inline' or      ancestor::*[4]/preceding-sibling::rules-subitem/@display-inline='yes-display-inline'  ">
				<xsl:value-of select="1 + number($countMax3)"/>
			</xsl:when>
			<xsl:otherwise>
				<xsl:value-of select="number($anc4_up_level) + number($countMax3)"/>
	...
	<xsl:template name="displayInlineRulesCount5">
		...
		<xsl:choose>
			<xsl:when test="ancestor::*[5]/@display-inline='yes-display-in'  or     ancestor::*[5]/preceding-sibling::rules-paragraph//@display-inline='yes-display-inline' or      ancestor::*[5]/preceding-sibling::rules-subparagraph//@display-inline='yes-display-inline' or      ancestor::*[5]/preceding-sibling::rules-subdivision//@display-inline='yes-display-inline' or      ancestor::*[5]/preceding-sibling::rules-item//@display-inline='yes-display-inline' or      ancestor::*[5]/preceding-sibling::rules-subitem//@display-inline='yes-display-inline' ">
				<xsl:value-of select="1 + number($countMax4)"/>
			</xsl:when>
			<xsl:otherwise>
				<xsl:value-of select="number($anc5_up_level) + number($countMax4)"/>
	...
	<xsl:template name="capitalizeReplacement">
		...
		<xsl:choose>
			<xsl:when test="  normalize-space(substring-after($aText, ' ' )) != ''">
				...
				<xsl:variable name="theFirstWordResult" select="concat(concat(concat($firstLetterPunctuation,$theFirstLetter),$theReastOfTheWord), ' ')"/>
